 ...
 */
import { isStdOperator, STD_MODULES } from './types.js';
 ...
 */
export const STD_OPERATORS_BY_MODULE = {
    math: MATH_OPERATORS,
    str: STR_OPERATORS,
 ...
 */
export function getStdOperatorMeta(operator) {
 ...
 */
export function isKnownStdOperator(operator) {
 ...
 */
export function getModuleOperators(module) {
 ...
 */
export function getAllStdOperators() {
 ...
 */
export function getStdOperatorsByModule(module) {
 ...
 */
export function getLambdaOperators() {
 ...
 */
export function getStdEffectOperators() {
    return Object.entries(STD_OPERATORS)
 ...
 */
export function getStdPureOperators() {
    return Object.entries(STD_OPERATORS)
        .filter(([, meta]) => !meta.hasSideEffects)
        .map(([name]) => name);
}
 ...
 */
export function validateStdOperatorArity(operator, argCount) {
 ...
 */
export function isStdGuardOperator(operator) {
    const meta = STD_OPERATORS[operator];
 ...
 */
export function isStdEffectOperator(operator) {
    const meta = STD_OPERATORS[operator];
 ...
 */
export function getOperatorMetaExtended(operator, coreOperators) {
 ...
 */
export function isKnownOperatorExtended(operator, coreOperators) {
    if (isStdOperator(operator)) {
        return operator in STD_OPERATORS;
    }
 ...
 */
export function validateOperatorArityExtended(operator, argCount, coreOperators) {
    if (isStdOperator(operator)) {
 ...
 * @returns true if operator has side effects
 */
export function isEffectOperatorExtended(operator, coreOperators) {
    if (isStdOperator(operator)) {
