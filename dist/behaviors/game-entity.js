 ...
 */
export const MOVEMENT_BEHAVIOR = {
    name: 'std/Movement',
    category: 'game-entity',
 ...
 */
export const INVENTORY_BEHAVIOR = {
    name: 'std/Inventory',
    category: 'game-entity',
...
// ============================================================================
export const GAME_ENTITY_BEHAVIORS = [
    HEALTH_BEHAVIOR,
    SCORE_BEHAVIOR,
    MOVEMENT_BEHAVIOR,
    COMBAT_BEHAVIOR,
