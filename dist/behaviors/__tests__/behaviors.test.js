...
import { 
// Types
BEHAVIOR_CATEGORIES, isBehaviorCategory, isGameBehaviorCategory, getBehaviorMetadata, validateBehaviorStructure, validateBehaviorEvents, validateBehaviorStates, 
// Action Affinity
ACTION_AFFINITY, UI_EVENTS, isActionValidForComponent, isActionInvalidForComponent, getValidActionsForComponent, validateActionsForComponent, getAllKnownComponents, getComponentsByCategory, 
// Registry
STANDARD_BEHAVIORS, BEHAVIOR_REGISTRY, getBehavior, isKnownBehavior, getBehaviorsByCategory, getAllBehaviorNames, getAllBehaviorMetadata, findBehaviorsForUseCase, getBehaviorsForEvent, validateBehaviorReference, getBehaviorLibraryStats, 
// Individual behaviors
LIST_BEHAVIOR, FORM_BEHAVIOR, MODAL_BEHAVIOR, PAGINATION_BEHAVIOR, NOTIFICATION_BEHAVIOR, } from '../index.js';
// ============================================================================
...
describe('Action Affinity', () => {
    ...
    describe('validateActionsForComponent', () => {
        it('returns empty array for valid actions', () => {
            const errors = validateActionsForComponent([{ event: 'VIEW' }, { event: 'EDIT' }], 'entity-table');
            expect(errors).toEqual([]);
        });
        it('returns errors for invalid actions', () => {
            const errors = validateActionsForComponent([{ event: 'VIEW' }, { event: 'SAVE' }], 'entity-table');
