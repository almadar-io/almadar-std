 ...
 */
// Types
export { BEHAVIOR_CATEGORIES, isBehaviorCategory, isGameBehaviorCategory, getBehaviorMetadata, validateBehaviorStructure, validateBehaviorEvents, validateBehaviorStates, } from './types.js';
// Action Affinity
export { ACTION_AFFINITY, UI_EVENTS, isActionValidForComponent, isActionInvalidForComponent, getValidActionsForComponent, getInvalidActionsForComponent, getComponentsForEvent, validateActionsForComponent, getAllKnownComponents, getComponentsByCategory, } from './action-affinity.js';
