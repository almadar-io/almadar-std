...
export const SESSION_OPERATORS: Record<string, StdOperatorMeta> = {
  'session/read-spec': {
    ...
    returnType: { kind: 'union', of: [{ kind: 'object', fields: { orbitalName: 'string', organism: 'string', method: 'string' } }, 'void'] },
  ...
  'session/read-memory': {
    ...
    hasSideEffects: false,
    returnType: { kind: 'union', of: [{ kind: 'object', fields: { entityName: 'string', notes: { kind: 'array', of: 'string' } }, open: true }, 'void'] },
    params: [{ name: 'orbitalName', type: 'string', description: 'Orbital name' }],
  ...
  'session/read-history': {
    ...
    hasSideEffects: false,
    returnType: { kind: 'array', of: { kind: 'object', fields: { role: 'string', content: 'string', timestamp: 'number' } } },
    params: [{ name: 'orbitalName', type: 'string', description: 'Orbital name' }],
  ...
  'session/read-errors': {
    ...
    hasSideEffects: false,
    returnType: { kind: 'array', of: 'ValidationError' },
    params: [{ name: 'orbitalName', type: 'string', description: 'Orbital name' }],
  ...
  'session/read-analysis': {
    ...
    hasSideEffects: false,
    returnType: { kind: 'union', of: [{ kind: 'object', fields: { orbitals: { kind: 'array', of: { kind: 'object', fields: { orbitalName: 'string', organism: 'string' } } } }, open: true }, 'void'] },
    params: [],
