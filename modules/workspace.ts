...
export const WORKSPACE_OPERATORS: Record<string, StdOperatorMeta> = {
  'workspace/read-orbital': {
    ...
    returnType: { kind: 'union', of: ['OrbitalDefinition', 'void'] },
  ...
  'workspace/read-file': {
    ...
    hasSideEffects: false,
    returnType: { kind: 'union', of: ['string', 'void'] },
  ...
  'workspace/list-orbitals': {
    ...
    hasSideEffects: false,
    returnType: { kind: 'array', of: 'string' },
    params: [],
  ...
  'workspace/read-schema': {
    ...
    hasSideEffects: false,
    returnType: { kind: 'union', of: ['OrbitalSchema', 'void'] },
    params: [],
  ...
  'workspace/read-plan': {
    ...
    hasSideEffects: false,
    returnType: { kind: 'union', of: [{ kind: 'object', fields: { id: 'string', status: 'string', organism: 'string' } }, 'void'] },
    params: [],
