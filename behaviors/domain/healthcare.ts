      ...
      traits: [
        {
          ...
          stateMachine: {
            ...
            events: [
              ...
              { key: 'SAVE', name: 'Save Reading', payloadSchema: [{ name: 'type', type: 'string', required: true }, { name: 'value', type: 'number', required: true }, { name: 'unit', type: 'string', required: true }] },
          ...
          stateMachine: {
            ...
            transitions: [
              ...
              },
              {
                ...
                effects: [
                  ['fetch', 'IntakeForm'],
                  ['render-ui', 'main', { type: 'page-header', title: 'Fill Out Form' }],
