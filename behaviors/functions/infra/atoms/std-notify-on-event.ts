 ...
 */
export type StdNotifyOnEventEventKey = 'EventOccurred' | 'NOTIFY_EMAIL_FAILED' | 'NOTIFY_EMAIL_SENT' | 'NOTIFY_SMS_FAILED' | 'NOTIFY_SMS_SENT' | 'NOTIFY_WEBHOOK_FAILED' | 'NOTIFY_WEBHOOK_SENT' | 'NotificationDispatched';
...
export interface StdNotifyOnEventConfig {
  ...
  listensFor?: string[];
  /** Default: `"in-app"` */
  notifyChannel?: 'in-app' | 'email' | 'sms' | 'webhook';
  /** Default: `{"end":"","start":""}` */
