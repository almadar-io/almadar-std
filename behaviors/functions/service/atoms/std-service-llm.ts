/**
 * std-service-llm — std-service-llm as a Function
 *
 ...
 */
export type StdServiceLlmEventKey = 'CLASSIFY' | 'COMPLETE' | 'FAILED' | 'GENERATE' | 'INIT' | 'RESET' | 'RETRY' | 'SUMMARIZE' | 'ServiceLlmLlmCompleted' | 'ServiceLlmLlmFailed' | 'ServiceLlmLoadFailed' | 'ServiceLlmLoaded';

/**
 * Payload shape for the `ServiceLlmLoaded` event.
 */
export interface StdServiceLlmServiceLlmLoadedPayload {
  id: string;
  inputText?: string;
  action?: string;
  result?: string;
...
/**
 * Payload shape for the `ServiceLlmLoadFailed` event.
 */
export interface StdServiceLlmServiceLlmLoadFailedPayload {
  message?: string;
}

/**
 * Payload shape for the `ServiceLlmLlmCompleted` event.
 */
export interface StdServiceLlmServiceLlmLlmCompletedPayload {
  result?: Record<string, unknown>;
}

/**
 * Payload shape for the `ServiceLlmLlmFailed` event.
 */
export interface StdServiceLlmServiceLlmLlmFailedPayload {
  error?: string;
  code?: string;
}
