...
/** Phase 9 manifest — describes the params surface of stdServiceResearchAssistantResearchOrbital. */
...
/** Phase 9 typed guard — runtime validates StdServiceResearchAssistantResearchOrbitalParams keys. */
export function isStdServiceResearchAssistantResearchOrbitalParams(p: object): p is StdServiceResearchAssistantResearchOrbitalParams {
  ...
  type _SpliceRecord = NonNullable<StdServiceResearchAssistantResearchOrbitalParams['interactionStates']>;
  ...
  if (obj.interactionStates !== undefined) {
    ...
    const allowed: readonly string[] = StdServiceResearchAssistantResearchOrbitalManifest.inlineTraitNames;
...
/** Phase 9 manifest — describes the params surface of stdServiceResearchAssistantCacheEntryOrbital. */
...
/** Phase 9 typed guard — runtime validates StdServiceResearchAssistantCacheEntryOrbitalParams keys. */
export function isStdServiceResearchAssistantCacheEntryOrbitalParams(p: object): p is StdServiceResearchAssistantCacheEntryOrbitalParams {
  ...
  type _SpliceRecord = NonNullable<StdServiceResearchAssistantCacheEntryOrbitalParams['interactionStates']>;
  const obj = p as { traitOverrides?: _OverrideRecord; interactionStates?: _SpliceRecord };
  if (obj.traitOverrides !== undefined) {
    if (typeof obj.traitOverrides !== "object" || obj.traitOverrides === null) return false;
  ...
  if (obj.interactionStates !== undefined) {
    if (typeof obj.interactionStates !== "object" || obj.interactionStates === null) return false;
    const allowed: readonly string[] = StdServiceResearchAssistantCacheEntryOrbitalManifest.inlineTraitNames;
    for (const k of Object.keys(obj.interactionStates)) {
      if (!allowed.includes(k)) return false;
    }
  }
...
/** Phase 9 manifest — describes the params surface of stdServiceResearchAssistantReportOrbital. */
...
/** Phase 9 typed guard — runtime validates StdServiceResearchAssistantReportOrbitalParams keys. */
export function isStdServiceResearchAssistantReportOrbitalParams(p: object): p is StdServiceResearchAssistantReportOrbitalParams {
  ...
  type _SpliceRecord = NonNullable<StdServiceResearchAssistantReportOrbitalParams['interactionStates']>;
  const obj = p as { traitOverrides?: _OverrideRecord; interactionStates?: _SpliceRecord };
  if (obj.traitOverrides !== undefined) {
    if (typeof obj.traitOverrides !== "object" || obj.traitOverrides === null) return false;
  ...
  if (obj.interactionStates !== undefined) {
    if (typeof obj.interactionStates !== "object" || obj.interactionStates === null) return false;
    const allowed: readonly string[] = StdServiceResearchAssistantReportOrbitalManifest.inlineTraitNames;
    for (const k of Object.keys(obj.interactionStates)) {
      if (!allowed.includes(k)) return false;
    }
  }
...
/** Phase 9 manifest — describes the params surface of stdServiceResearchAssistantKnowledgeQueryOrbital. */
...
/** Phase 9 typed guard — runtime validates StdServiceResearchAssistantKnowledgeQueryOrbitalParams keys. */
export function isStdServiceResearchAssistantKnowledgeQueryOrbitalParams(p: object): p is StdServiceResearchAssistantKnowledgeQueryOrbitalParams {
  ...
  type _SpliceRecord = NonNullable<StdServiceResearchAssistantKnowledgeQueryOrbitalParams['interactionStates']>;
  const obj = p as { traitOverrides?: _OverrideRecord; interactionStates?: _SpliceRecord };
  if (obj.traitOverrides !== undefined) {
    if (typeof obj.traitOverrides !== "object" || obj.traitOverrides === null) return false;
  ...
  if (obj.interactionStates !== undefined) {
    if (typeof obj.interactionStates !== "object" || obj.interactionStates === null) return false;
    const allowed: readonly string[] = StdServiceResearchAssistantKnowledgeQueryOrbitalManifest.inlineTraitNames;
    for (const k of Object.keys(obj.interactionStates)) {
      if (!allowed.includes(k)) return false;
    }
  }
