...
/** Phase 9 manifest — describes the params surface of stdPuzzleAppPuzzleLevelOrbital. */
...
/** Phase 9 typed guard — runtime validates StdPuzzleAppPuzzleLevelOrbitalParams keys. */
export function isStdPuzzleAppPuzzleLevelOrbitalParams(p: object): p is StdPuzzleAppPuzzleLevelOrbitalParams {
  ...
  type _SpliceRecord = NonNullable<StdPuzzleAppPuzzleLevelOrbitalParams['interactionStates']>;
  ...
  if (obj.interactionStates !== undefined) {
    ...
    const allowed: readonly string[] = StdPuzzleAppPuzzleLevelOrbitalManifest.inlineTraitNames;
...
/** Phase 9 manifest — describes the params surface of stdPuzzleAppPuzzleScoreOrbital. */
...
/** Phase 9 typed guard — runtime validates StdPuzzleAppPuzzleScoreOrbitalParams keys. */
export function isStdPuzzleAppPuzzleScoreOrbitalParams(p: object): p is StdPuzzleAppPuzzleScoreOrbitalParams {
  ...
  type _SpliceRecord = NonNullable<StdPuzzleAppPuzzleScoreOrbitalParams['interactionStates']>;
  const obj = p as { traitOverrides?: _OverrideRecord; interactionStates?: _SpliceRecord };
  if (obj.traitOverrides !== undefined) {
    if (typeof obj.traitOverrides !== "object" || obj.traitOverrides === null) return false;
  ...
  if (obj.interactionStates !== undefined) {
    if (typeof obj.interactionStates !== "object" || obj.interactionStates === null) return false;
    const allowed: readonly string[] = StdPuzzleAppPuzzleScoreOrbitalManifest.inlineTraitNames;
    for (const k of Object.keys(obj.interactionStates)) {
      if (!allowed.includes(k)) return false;
    }
  }
