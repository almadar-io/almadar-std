/**
 * std-timer — std-timer as a Function
 *
 * Autogenerated by scripts/regenerate-std-ts.mjs from
 * packages/almadar-std/behaviors/registry/atoms/std-timer.orb.
 *
 ...
 *   node scripts/regenerate-std-ts.mjs --only=std-timer
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/std-timer';
const ALIAS = 'Timer';
 ...
 */
export type StdTimerEventKey = 'EXPIRE' | 'INIT' | 'PAUSE' | 'RESET' | 'RESUME' | 'START' | 'TICK';

/**
 * Params for the std-timer descriptor helpers.
 *
...
export interface StdTimerParams {
  ...
  events?: Partial<Record<StdTimerEventKey, string>>;
...
/** Trait descriptor: `Timer.traits.TimerSessionTimer`. */
export function stdTimerTrait(params: StdTimerParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.TimerSessionTimer`,
...
/** Page descriptor: `Timer.pages.TimerSessionTimerPage`. */
export function stdTimerPage(params: StdTimerParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.TimerSessionTimerPage`,
