/**
 * std-cache-aside — Cache management behavior: empty, cached, stale with fetch/invalidate cycle. Pure function: params in, OrbitalDefinition out.
 *
 ...
 *   node scripts/regenerate-std-ts.mjs --only=std-cache-aside
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/atoms/std-cache-aside';
...
export function stdCacheAsideTrait(params: StdCacheAsideParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
