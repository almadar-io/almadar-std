/**
 * std-score-board — Score display atom using the `score-board` pattern. Shows score, high score, combo, multiplier, level.
 *
 * Autogenerated by scripts/regenerate-std-ts.mjs from
 * packages/almadar-std/behaviors/registry/atoms/std-score-board.orb.
 *
 ...
 *   node scripts/regenerate-std-ts.mjs --only=std-score-board
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/atoms/std-score-board';
const ALIAS = 'ScoreBoard';

/**
 * Params for the std-score-board descriptor helpers.
 *
...
/** Trait descriptor: `ScoreBoard.traits.ScoreBoardEntryScoreBoard`. */
export function stdScoreBoardTrait(params: StdScoreBoardParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.ScoreBoardEntryScoreBoard`,
...
/** Page descriptor: `ScoreBoard.pages.ScoreBoardEntryScorePage`. */
export function stdScoreBoardPage(params: StdScoreBoardParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.ScoreBoardEntryScorePage`,
...
export function stdScoreBoard(params: StdScoreBoardParams): OrbitalDefinition {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdScoreBoardTrait(params),
    ],
    pages: [
      stdScoreBoardPage(params),
    ],
  });
}
