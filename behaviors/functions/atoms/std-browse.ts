/**
 * std-browse — Data grid browsing atom. Renders a list of entities with configurable item actions. The browsing view that molecules compose with modal/confirmation atoms.
 *
...
const BEHAVIOR_PATH = 'std/behaviors/atoms/std-browse';
const ALIAS = 'Browse';
