/**
 * std-service-email — Email service integration behavior: compose, send, track delivery status. Wraps the `email` service with call-service for send operations. Pure function: params in, OrbitalDefinition out.
 *
...
const BEHAVIOR_PATH = 'std/behaviors/atoms/std-service-email';
