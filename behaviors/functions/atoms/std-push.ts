/**
 * std-push — External-event subscription atom. Wraps os/watch-http with a lifecycle state machine (idle → subscribed ↔ reconnecting) using emit: config to turn incoming messages + failures into closed-circuit events.
 *
