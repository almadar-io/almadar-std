/**
 * std-notification — std-notification as a Function
 *
 * Autogenerated by scripts/regenerate-std-ts.mjs from
 * packages/almadar-std/behaviors/registry/atoms/std-notification.orb.
 *
 ...
 *   node scripts/regenerate-std-ts.mjs --only=std-notification
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/atoms/std-notification';
const ALIAS = 'Notification';

/**
 * Params for the std-notification descriptor helpers.
 *
...
/** Trait descriptor: `Notification.traits.NotificationNotification`. */
export function stdNotificationTrait(params: StdNotificationParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.NotificationNotification`,
...
/** Page descriptor: `Notification.pages.NotificationNotificationPage`. */
export function stdNotificationPage(params: StdNotificationParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.NotificationNotificationPage`,
...
export function stdNotification(params: StdNotificationParams): OrbitalDefinition {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdNotificationTrait(params),
    ],
    pages: [
      stdNotificationPage(params),
    ],
  });
}
