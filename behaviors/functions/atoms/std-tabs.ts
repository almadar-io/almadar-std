/**
 * std-tabs — Tab navigation atom. Uses the `tabs` pattern component with clickable tab headers. Each tab shows different entity data.
 *
...
const BEHAVIOR_PATH = 'std/behaviors/atoms/std-tabs';
const ALIAS = 'Tabs';
...
/** Trait descriptor: `Tabs.traits.TabContentTabs`. */
export function stdTabsTrait(params: StdTabsParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.TabContentTabs`,
...
/** Page descriptor: `Tabs.pages.TabContentTabsPage`. */
export function stdTabsPage(params: StdTabsParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.TabContentTabsPage`,
