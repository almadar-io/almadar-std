/**
 * std-input — std-input as a Function
 *
 * Autogenerated by scripts/regenerate-std-ts.mjs from
 * packages/almadar-std/behaviors/registry/atoms/std-input.orb.
 *
 ...
 *   node scripts/regenerate-std-ts.mjs --only=std-input
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/atoms/std-input';
const ALIAS = 'Input';

/**
 * Params for the std-input descriptor helpers.
 *
...
/** Trait descriptor: `Input.traits.TextInputInput`. */
export function stdInputTrait(params: StdInputParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.TextInputInput`,
...
/** Page descriptor: `Input.pages.TextInputInputPage`. */
export function stdInputPage(params: StdInputParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.TextInputInputPage`,
