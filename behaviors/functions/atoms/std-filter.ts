/**
 * std-filter — Filter atom. Shows filter buttons per field with predefined values. Clicking a filter value transitions to filtered state. Clear resets.
 *
...
const BEHAVIOR_PATH = 'std/behaviors/atoms/std-filter';
const ALIAS = 'Filter';
