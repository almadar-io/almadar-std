/**
 * std-score — std-score as a Function
 *
 ...
 *   node scripts/regenerate-std-ts.mjs --only=std-score
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/atoms/std-score';
const ALIAS = 'Score';
...
/** Trait descriptor: `Score.traits.ScoreEntryScore`. */
export function stdScoreTrait(params: StdScoreParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.ScoreEntryScore`,
...
/** Page descriptor: `Score.pages.ScoreEntryScorePage`. */
export function stdScorePage(params: StdScoreParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.ScoreEntryScorePage`,
