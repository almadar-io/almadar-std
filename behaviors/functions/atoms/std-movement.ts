/**
 * std-movement — Entity movement behavior: idle, moving, collision detection and resolution. Pure function: params in, OrbitalDefinition out.
 *
...
const BEHAVIOR_PATH = 'std/behaviors/atoms/std-movement';
