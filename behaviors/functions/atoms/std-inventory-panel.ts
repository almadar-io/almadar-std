/**
 * std-inventory-panel — Grid-based inventory atom using the `inventory-panel` pattern. Shows items in a grid with select, use, and drop actions.
 *
 * Autogenerated by scripts/regenerate-std-ts.mjs from
 * packages/almadar-std/behaviors/registry/atoms/std-inventory-panel.orb.
 *
 ...
 *   node scripts/regenerate-std-ts.mjs --only=std-inventory-panel
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/atoms/std-inventory-panel';
const ALIAS = 'InventoryPanel';

/**
 * Params for the std-inventory-panel descriptor helpers.
 *
...
/** Trait descriptor: `InventoryPanel.traits.InventorySlotInventoryPanel`. */
export function stdInventoryPanelTrait(params: StdInventoryPanelParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.InventorySlotInventoryPanel`,
...
/** Page descriptor: `InventoryPanel.pages.InventorySlotInventoryPage`. */
export function stdInventoryPanelPage(params: StdInventoryPanelParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.InventorySlotInventoryPage`,
...
export function stdInventoryPanel(params: StdInventoryPanelParams): OrbitalDefinition {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdInventoryPanelTrait(params),
    ],
    pages: [
      stdInventoryPanelPage(params),
    ],
  });
}
