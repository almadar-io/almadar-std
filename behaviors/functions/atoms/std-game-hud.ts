/**
 * std-game-hud — Heads-up display atom. Renders the `game-hud` pattern showing health, score, lives, and other stats.
 *
 * Autogenerated by scripts/regenerate-std-ts.mjs from
 * packages/almadar-std/behaviors/registry/atoms/std-game-hud.orb.
 *
 ...
 *   node scripts/regenerate-std-ts.mjs --only=std-game-hud
 *
 * @level atom
...
/**
 * Params for the std-game-hud descriptor helpers.
 *
...
/** Trait descriptor: `GameHud.traits.HudStateHud`. */
export function stdGameHudTrait(params: StdGameHudParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.HudStateHud`,
...
/** Page descriptor: `GameHud.pages.HudStateHudPage`. */
export function stdGameHudPage(params: StdGameHudParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.HudStateHudPage`,
...
export function stdGameHud(params: StdGameHudParams): OrbitalDefinition {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdGameHudTrait(params),
    ],
    pages: [
      stdGameHudPage(params),
    ],
  });
}
