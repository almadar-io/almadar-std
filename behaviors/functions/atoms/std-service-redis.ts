/**
 * std-service-redis — Redis cache integration behavior: get, set, delete with TTL support. Wraps the `redis` service with separate events for each operation. Pure function: params in, OrbitalDefinition out.
 *
...
const BEHAVIOR_PATH = 'std/behaviors/atoms/std-service-redis';
