/**
 * std-gallery — Image gallery atom with carousel browsing and lightbox viewing. Absorbs: carousel, lightbox.
 *
...
const BEHAVIOR_PATH = 'std/behaviors/atoms/std-gallery';
const ALIAS = 'Gallery';
