/**
 * std-related — Relation-walking atom. Fetches the linked entity with include: hydrating a declared relation, emits FETCH_OK on success, renders populated children as a data-list.
 *
