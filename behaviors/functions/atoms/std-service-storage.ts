/**
 * std-service-storage — Storage service integration behavior: upload, download, list, delete files. Wraps the `storage` service with separate events for each operation. Pure function: params in, OrbitalDefinition out.
 *
...
const BEHAVIOR_PATH = 'std/behaviors/atoms/std-service-storage';
