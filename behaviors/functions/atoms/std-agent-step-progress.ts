/**
 * std-agent-step-progress — Pipeline/workflow step indicator atom. Tracks progress through a series of named steps with start/advance/complete/fail lifecycle. Listens for ADVANCE, COMPLETE, FAIL so orchestrating traits can drive the progress externally.
 *
...
const BEHAVIOR_PATH = 'std/behaviors/atoms/std-agent-step-progress';
