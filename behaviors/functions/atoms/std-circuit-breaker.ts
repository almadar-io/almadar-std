/**
 * std-circuit-breaker — Circuit breaker pattern behavior: closed, open, halfOpen. Protects services from cascading failures with automatic recovery. Pure function: params in, OrbitalDefinition out.
 *
 ...
 *   node scripts/regenerate-std-ts.mjs --only=std-circuit-breaker
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/atoms/std-circuit-breaker';
