/**
 * std-async — Async operation behavior: idle, loading, success, error. Covers fetch, submit, retry, and polling patterns in one molecule. Pure function: params in, OrbitalDefinition out.
 *
 * Autogenerated by scripts/regenerate-std-ts.mjs from
 * packages/almadar-std/behaviors/registry/atoms/std-async.orb.
 *
 ...
 *   node scripts/regenerate-std-ts.mjs --only=std-async
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/atoms/std-async';
const ALIAS = 'Async';

/**
 * Params for the std-async descriptor helpers.
 *
...
/** Trait descriptor: `Async.traits.AsyncTaskAsync`. */
export function stdAsyncTrait(params: StdAsyncParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.AsyncTaskAsync`,
...
/** Page descriptor: `Async.pages.AsyncTaskPage`. */
export function stdAsyncPage(params: StdAsyncParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.AsyncTaskPage`,
