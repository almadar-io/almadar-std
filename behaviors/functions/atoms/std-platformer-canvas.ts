/**
 * std-platformer-canvas — Side-scrolling platformer atom using the `platformer-canvas` pattern. Renders player, platforms, and handles movement events.
 *
 * Autogenerated by scripts/regenerate-std-ts.mjs from
 * packages/almadar-std/behaviors/registry/atoms/std-platformer-canvas.orb.
 *
 ...
 *   node scripts/regenerate-std-ts.mjs --only=std-platformer-canvas
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/atoms/std-platformer-canvas';
const ALIAS = 'PlatformerCanvas';

/**
 * Params for the std-platformer-canvas descriptor helpers.
 *
...
/** Trait descriptor: `PlatformerCanvas.traits.PlatformerWorldPlatformerCanvas`. */
export function stdPlatformerCanvasTrait(params: StdPlatformerCanvasParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.PlatformerWorldPlatformerCanvas`,
...
/** Page descriptor: `PlatformerCanvas.pages.PlatformerWorldPlatformerPage`. */
export function stdPlatformerCanvasPage(params: StdPlatformerCanvasParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.PlatformerWorldPlatformerPage`,
...
export function stdPlatformerCanvas(params: StdPlatformerCanvasParams): OrbitalDefinition {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdPlatformerCanvasTrait(params),
    ],
    pages: [
      stdPlatformerCanvasPage(params),
    ],
  });
}
