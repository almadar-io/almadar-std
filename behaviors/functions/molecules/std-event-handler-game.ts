/**
 * std-event-handler-game — Educational game molecule: menu -> playing -> complete. Uses the `event-handler-board` pattern for the playing state.
 *
 * Autogenerated by scripts/regenerate-std-ts.mjs from
 * packages/almadar-std/behaviors/registry/molecules/std-event-handler-game.orb.
 *
 ...
 *   node scripts/regenerate-std-ts.mjs --only=std-event-handler-game
 *
 * @level molecule
...
/**
 * Params for the std-event-handler-game descriptor helpers.
 *
...
/** Trait descriptor: `EventHandlerGame.traits.EventHandlerGameEventHandlerGame`. */
export function stdEventHandlerGameTrait(params: StdEventHandlerGameParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.EventHandlerGameEventHandlerGame`,
...
/** Page descriptor: `EventHandlerGame.pages.EventHandlerGamePage`. */
export function stdEventHandlerGamePage(params: StdEventHandlerGameParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.EventHandlerGamePage`,
...
export function stdEventHandlerGame(params: StdEventHandlerGameParams): OrbitalDefinition {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdEventHandlerGameTrait(params),
    ],
    pages: [
      stdEventHandlerGamePage(params),
    ],
  });
}
