/**
 * std-cart — Shopping cart molecule. Composes atoms: - Cart-specific browse trait (empty/hasItems/checkout states) - stdModal for the add-item form (responds to ADD_ITEM)
 *
...
const BEHAVIOR_PATH = 'std/behaviors/molecules/std-cart';
const ALIAS = 'Cart';
