...
function buildEntity(c: NegotiatorGameConfig): Entity {
  const instances = [
    { id: 'game-1', name: 'Negotiation Session', description: 'Active game session', status: 'active', score: 0, level: 1 },
  ];
...
export function stdNegotiatorGame(params: StdNegotiatorGameParams): OrbitalSchema {
