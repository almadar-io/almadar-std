/**
 * std-puzzle-game — Puzzle game molecule. Composes game atoms into a two-trait orbital:
 *
 * Autogenerated by scripts/regenerate-std-ts.mjs from
 * packages/almadar-std/behaviors/registry/molecules/std-puzzle-game.orb.
 *
 ...
 *   node scripts/regenerate-std-ts.mjs --only=std-puzzle-game
 *
 * @level molecule
...
const BEHAVIOR_PATH = 'std/behaviors/std-puzzle-game';
const ALIAS = 'PuzzleGame';

/**
 * Params for the std-puzzle-game descriptor helpers.
 *
...
/** Trait descriptor: `PuzzleGame.traits.PuzzleBoardPuzzleFlow`. */
export function stdPuzzleGamePuzzleBoardPuzzleFlowTrait(params: StdPuzzleGameParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.PuzzleBoardPuzzleFlow`,
...
/** Trait descriptor: `PuzzleGame.traits.PuzzleBoardPuzzleScore`. */
export function stdPuzzleGamePuzzleBoardPuzzleScoreTrait(params: StdPuzzleGameParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.PuzzleBoardPuzzleScore`,
    linkedEntity: params.entityName,
    ...(params.traitName !== undefined ? { name: params.traitName } : {}),
    ...(params.events !== undefined ? { events: params.events } : {}),
    ...(params.effects !== undefined ? { effects: params.effects as Record<string, never> } : {}),
...
/** Page descriptor: `PuzzleGame.pages.PuzzleBoardPage`. */
export function stdPuzzleGamePage(params: StdPuzzleGameParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.PuzzleBoardPage`,
...
export function stdPuzzleGame(params: StdPuzzleGameParams): OrbitalDefinition {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdPuzzleGamePuzzleBoardPuzzleFlowTrait(params),
      stdPuzzleGamePuzzleBoardPuzzleScoreTrait(params),
    ],
    pages: [
      stdPuzzleGamePage(params),
    ],
  });
}
