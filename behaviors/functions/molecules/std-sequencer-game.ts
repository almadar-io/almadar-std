/**
 * std-sequencer-game — Educational game molecule: menu -> playing -> complete. Uses the `sequencer-board` pattern for the playing state.
 *
 * Autogenerated by scripts/regenerate-std-ts.mjs from
 * packages/almadar-std/behaviors/registry/molecules/std-sequencer-game.orb.
 *
 ...
 *   node scripts/regenerate-std-ts.mjs --only=std-sequencer-game
 *
 * @level molecule
...
const BEHAVIOR_PATH = 'std/behaviors/molecules/std-sequencer-game';
const ALIAS = 'SequencerGame';

/**
 * Params for the std-sequencer-game descriptor helpers.
 *
...
/** Trait descriptor: `SequencerGame.traits.SequencerGameSequencerGame`. */
export function stdSequencerGameTrait(params: StdSequencerGameParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.SequencerGameSequencerGame`,
...
/** Page descriptor: `SequencerGame.pages.SequencerGamePage`. */
export function stdSequencerGamePage(params: StdSequencerGameParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.SequencerGamePage`,
...
export function stdSequencerGame(params: StdSequencerGameParams): OrbitalDefinition {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdSequencerGameTrait(params),
    ],
    pages: [
      stdSequencerGamePage(params),
    ],
  });
}
