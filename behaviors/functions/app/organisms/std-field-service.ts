...
export interface StdFieldServiceWorkOrderOrbitalParams {
  ...
  interactionStates?: Partial<Record<
    'WorkOrderCatalog' | 'WorkOrderPersistor',
...
/** Phase 9 manifest — describes the params surface of stdFieldServiceWorkOrderOrbital. */
...
/** Phase 9 typed guard — runtime validates StdFieldServiceWorkOrderOrbitalParams keys. */
export function isStdFieldServiceWorkOrderOrbitalParams(p: object): p is StdFieldServiceWorkOrderOrbitalParams {
  ...
  type _SpliceRecord = NonNullable<StdFieldServiceWorkOrderOrbitalParams['interactionStates']>;
  ...
  if (obj.interactionStates !== undefined) {
    ...
    const allowed: readonly string[] = StdFieldServiceWorkOrderOrbitalManifest.inlineTraitNames;
...
export interface StdFieldServiceTechnicianOrbitalParams {
   ...
   */
  interactionStates?: Partial<Record<
    'TechnicianCatalog' | 'TechnicianPersistor',
    Partial<Pick<NonNullable<Trait['stateMachine']>, 'states' | 'events' | 'transitions'>>
  >>;
}
...
/** Phase 9 manifest — describes the params surface of stdFieldServiceTechnicianOrbital. */
...
/** Phase 9 typed guard — runtime validates StdFieldServiceTechnicianOrbitalParams keys. */
export function isStdFieldServiceTechnicianOrbitalParams(p: object): p is StdFieldServiceTechnicianOrbitalParams {
  ...
  type _SpliceRecord = NonNullable<StdFieldServiceTechnicianOrbitalParams['interactionStates']>;
  const obj = p as { traitOverrides?: _OverrideRecord; interactionStates?: _SpliceRecord };
  if (obj.traitOverrides !== undefined) {
    if (typeof obj.traitOverrides !== "object" || obj.traitOverrides === null) return false;
  ...
  if (obj.interactionStates !== undefined) {
    if (typeof obj.interactionStates !== "object" || obj.interactionStates === null) return false;
    const allowed: readonly string[] = StdFieldServiceTechnicianOrbitalManifest.inlineTraitNames;
    for (const k of Object.keys(obj.interactionStates)) {
      if (!allowed.includes(k)) return false;
    }
  }
...
/** Phase 9 manifest — describes the params surface of stdFieldServiceJobCheckinOrbital. */
...
/** Phase 9 typed guard — runtime validates StdFieldServiceJobCheckinOrbitalParams keys. */
export function isStdFieldServiceJobCheckinOrbitalParams(p: object): p is StdFieldServiceJobCheckinOrbitalParams {
  ...
  type _SpliceRecord = NonNullable<StdFieldServiceJobCheckinOrbitalParams['interactionStates']>;
  const obj = p as { traitOverrides?: _OverrideRecord; interactionStates?: _SpliceRecord };
  if (obj.traitOverrides !== undefined) {
    if (typeof obj.traitOverrides !== "object" || obj.traitOverrides === null) return false;
  ...
  if (obj.interactionStates !== undefined) {
    if (typeof obj.interactionStates !== "object" || obj.interactionStates === null) return false;
    const allowed: readonly string[] = StdFieldServiceJobCheckinOrbitalManifest.inlineTraitNames;
    for (const k of Object.keys(obj.interactionStates)) {
      if (!allowed.includes(k)) return false;
    }
  }
