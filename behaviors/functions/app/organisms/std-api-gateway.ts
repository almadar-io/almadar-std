...
/** Phase 9 manifest — describes the params surface of stdApiGatewayRouteOrbital. */
...
/** Phase 9 typed guard — runtime validates StdApiGatewayRouteOrbitalParams keys. */
export function isStdApiGatewayRouteOrbitalParams(p: object): p is StdApiGatewayRouteOrbitalParams {
  ...
  type _SpliceRecord = NonNullable<StdApiGatewayRouteOrbitalParams['interactionStates']>;
  ...
  if (obj.interactionStates !== undefined) {
    ...
    const allowed: readonly string[] = StdApiGatewayRouteOrbitalManifest.inlineTraitNames;
...
export interface StdApiGatewayBackendOrbitalParams {
   ...
   */
  interactionStates?: Partial<Record<
    'BackendCatalog' | 'BackendPersistor',
    Partial<Pick<NonNullable<Trait['stateMachine']>, 'states' | 'events' | 'transitions'>>
  >>;
}
...
/** Phase 9 manifest — describes the params surface of stdApiGatewayBackendOrbital. */
...
/** Phase 9 typed guard — runtime validates StdApiGatewayBackendOrbitalParams keys. */
export function isStdApiGatewayBackendOrbitalParams(p: object): p is StdApiGatewayBackendOrbitalParams {
  ...
  type _SpliceRecord = NonNullable<StdApiGatewayBackendOrbitalParams['interactionStates']>;
  const obj = p as { traitOverrides?: _OverrideRecord; interactionStates?: _SpliceRecord };
  if (obj.traitOverrides !== undefined) {
    if (typeof obj.traitOverrides !== "object" || obj.traitOverrides === null) return false;
  ...
  if (obj.interactionStates !== undefined) {
    if (typeof obj.interactionStates !== "object" || obj.interactionStates === null) return false;
    const allowed: readonly string[] = StdApiGatewayBackendOrbitalManifest.inlineTraitNames;
    for (const k of Object.keys(obj.interactionStates)) {
      if (!allowed.includes(k)) return false;
    }
  }
...
/** Phase 9 manifest — describes the params surface of stdApiGatewayAnalyticsOrbital. */
...
/** Phase 9 typed guard — runtime validates StdApiGatewayAnalyticsOrbitalParams keys. */
export function isStdApiGatewayAnalyticsOrbitalParams(p: object): p is StdApiGatewayAnalyticsOrbitalParams {
  ...
  type _SpliceRecord = NonNullable<StdApiGatewayAnalyticsOrbitalParams['interactionStates']>;
  const obj = p as { traitOverrides?: _OverrideRecord; interactionStates?: _SpliceRecord };
  if (obj.traitOverrides !== undefined) {
    if (typeof obj.traitOverrides !== "object" || obj.traitOverrides === null) return false;
  ...
  if (obj.interactionStates !== undefined) {
    if (typeof obj.interactionStates !== "object" || obj.interactionStates === null) return false;
    const allowed: readonly string[] = StdApiGatewayAnalyticsOrbitalManifest.inlineTraitNames;
    for (const k of Object.keys(obj.interactionStates)) {
      if (!allowed.includes(k)) return false;
    }
  }
