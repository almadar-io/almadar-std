...
/** Phase 9 manifest — describes the params surface of stdCicdPipelineBuildOrbital. */
...
/** Phase 9 typed guard — runtime validates StdCicdPipelineBuildOrbitalParams keys. */
export function isStdCicdPipelineBuildOrbitalParams(p: object): p is StdCicdPipelineBuildOrbitalParams {
  ...
  type _SpliceRecord = NonNullable<StdCicdPipelineBuildOrbitalParams['interactionStates']>;
  ...
  if (obj.interactionStates !== undefined) {
    ...
    const allowed: readonly string[] = StdCicdPipelineBuildOrbitalManifest.inlineTraitNames;
...
/** Phase 9 manifest — describes the params surface of stdCicdPipelineStageOrbital. */
...
/** Phase 9 typed guard — runtime validates StdCicdPipelineStageOrbitalParams keys. */
export function isStdCicdPipelineStageOrbitalParams(p: object): p is StdCicdPipelineStageOrbitalParams {
  ...
  type _SpliceRecord = NonNullable<StdCicdPipelineStageOrbitalParams['interactionStates']>;
  const obj = p as { traitOverrides?: _OverrideRecord; interactionStates?: _SpliceRecord };
  if (obj.traitOverrides !== undefined) {
    if (typeof obj.traitOverrides !== "object" || obj.traitOverrides === null) return false;
  ...
  if (obj.interactionStates !== undefined) {
    if (typeof obj.interactionStates !== "object" || obj.interactionStates === null) return false;
    const allowed: readonly string[] = StdCicdPipelineStageOrbitalManifest.inlineTraitNames;
    for (const k of Object.keys(obj.interactionStates)) {
      if (!allowed.includes(k)) return false;
    }
  }
...
export interface StdCicdPipelineDeploymentOrbitalParams {
   ...
   */
  interactionStates?: Partial<Record<
    'DeploymentDisplay' | 'DeploymentCommitsPanel' | 'DeploymentAsync',
    Partial<Pick<NonNullable<Trait['stateMachine']>, 'states' | 'events' | 'transitions'>>
  >>;
}
...
/** Phase 9 manifest — describes the params surface of stdCicdPipelineDeploymentOrbital. */
...
/** Phase 9 typed guard — runtime validates StdCicdPipelineDeploymentOrbitalParams keys. */
export function isStdCicdPipelineDeploymentOrbitalParams(p: object): p is StdCicdPipelineDeploymentOrbitalParams {
  ...
  type _SpliceRecord = NonNullable<StdCicdPipelineDeploymentOrbitalParams['interactionStates']>;
  const obj = p as { traitOverrides?: _OverrideRecord; interactionStates?: _SpliceRecord };
  if (obj.traitOverrides !== undefined) {
    if (typeof obj.traitOverrides !== "object" || obj.traitOverrides === null) return false;
  ...
  if (obj.interactionStates !== undefined) {
    if (typeof obj.interactionStates !== "object" || obj.interactionStates === null) return false;
    const allowed: readonly string[] = StdCicdPipelineDeploymentOrbitalManifest.inlineTraitNames;
    for (const k of Object.keys(obj.interactionStates)) {
      if (!allowed.includes(k)) return false;
    }
  }
