...
/** Phase 9 manifest — describes the params surface of stdListingsListingOrbital. */
...
/** Phase 9 typed guard — runtime validates StdListingsListingOrbitalParams keys. */
export function isStdListingsListingOrbitalParams(p: object): p is StdListingsListingOrbitalParams {
  ...
  type _SpliceRecord = NonNullable<StdListingsListingOrbitalParams['interactionStates']>;
  ...
  if (obj.interactionStates !== undefined) {
    ...
    const allowed: readonly string[] = StdListingsListingOrbitalManifest.inlineTraitNames;
...
export interface StdListingsInquiryOrbitalParams {
   ...
   */
  interactionStates?: Partial<Record<
    'InquiryBrowse' | 'InquiryPersistor',
    Partial<Pick<NonNullable<Trait['stateMachine']>, 'states' | 'events' | 'transitions'>>
  >>;
}
...
/** Phase 9 manifest — describes the params surface of stdListingsInquiryOrbital. */
...
/** Phase 9 typed guard — runtime validates StdListingsInquiryOrbitalParams keys. */
export function isStdListingsInquiryOrbitalParams(p: object): p is StdListingsInquiryOrbitalParams {
  ...
  type _SpliceRecord = NonNullable<StdListingsInquiryOrbitalParams['interactionStates']>;
  const obj = p as { traitOverrides?: _OverrideRecord; interactionStates?: _SpliceRecord };
  if (obj.traitOverrides !== undefined) {
    if (typeof obj.traitOverrides !== "object" || obj.traitOverrides === null) return false;
  ...
  if (obj.interactionStates !== undefined) {
    if (typeof obj.interactionStates !== "object" || obj.interactionStates === null) return false;
    const allowed: readonly string[] = StdListingsInquiryOrbitalManifest.inlineTraitNames;
    for (const k of Object.keys(obj.interactionStates)) {
      if (!allowed.includes(k)) return false;
    }
  }
