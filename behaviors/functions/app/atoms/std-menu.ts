/**
 * std-menu — std-menu — restaurant POS menu items grouped by category with availability windows. Manage trait loads, browses, persists Create / Update / Toggle-Available / Delete. Exposes Restaurant/POS knobs (serviceCharge, tipPresets, allergenWarningsEnabled, …).
 *
