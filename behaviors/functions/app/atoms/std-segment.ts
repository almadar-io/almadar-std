/**
 * std-segment — std-segment — contact segment primitive grouping contacts by criteria with Recalculate action. Exposes CRM-pattern knobs (health-score threshold, reminder cadence, archive policy, consent).
 *
