/**
 * std-warehouse — std-warehouse — physical or logical storage location. Lists warehouses; detail shows code, address, type, active flag, SKU count. Exposes Inventory/Logistics knobs (multiLocationEnabled, hazmatEnabled, …) for the questionnaire.
 *
