/**
 * std-health-score — std-health-score — customer success composite score (usage/support/engagement) with Recalculate / Assign CSM. Exposes CRM-pattern knobs (alert threshold, reminder cadence, archive policy, consent).
 *
