/**
 * std-donor — std-donor — nonprofit donor (individual/org/foundation) with Thank / Solicit actions. Exposes CRM-pattern knobs (alert threshold, reminder cadence, archive policy, consent).
 *
