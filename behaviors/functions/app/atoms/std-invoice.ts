 ...
 */
export type StdInvoiceEventKey = 'CLOSE_VIEW' | 'INIT' | 'InvoiceLoadFailed' | 'InvoiceLoaded' | 'InvoiceRefundFailed' | 'InvoiceRefunded' | 'InvoiceUpdateFailed' | 'InvoiceUpdated' | 'MARK_PAID' | 'OPEN_INVOICE' | 'REFUND' | 'SEND' | 'SET_STATUS' | 'VOID';
