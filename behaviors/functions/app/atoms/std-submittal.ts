/**
 * std-submittal — std-submittal — construction submittal lifecycle. Listens for SET_STATUS so std-lifecycle can auto-escalate SLA breaches. Exposes Service/Operations knobs (responseTimeMinutes, resolutionSLAHours, …).
 *
 ...
 */
export type StdSubmittalEventKey = 'APPROVE' | 'CLOSE_VIEW' | 'INIT' | 'OPEN_SUBMITTAL' | 'REJECT' | 'REQUEST_DELETE' | 'REQUEST_REVISION' | 'SET_STATUS' | 'SubmittalLoadFailed' | 'SubmittalLoaded';
