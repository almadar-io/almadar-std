/**
 * std-offer-letter — std-offer-letter — formal job offer lifecycle. Listens for SET_STATUS so std-lifecycle can auto-expire offers past expiresAt. Exposes HR knobs (backgroundCheckRequired, eVerifyRequired, anonymizeOnRejection, …).
 *
 ...
 */
export type StdOfferLetterEventKey = 'CLOSE_VIEW' | 'INIT' | 'OPEN_OFFER' | 'OfferLetterLoadFailed' | 'OfferLetterLoaded' | 'REVOKE_OFFER' | 'SEND_OFFER' | 'SET_STATUS';
