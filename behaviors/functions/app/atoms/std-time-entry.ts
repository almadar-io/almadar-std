/**
 * std-time-entry — std-time-entry — time tracking line within a timesheet. Listens for SET_STATUS so std-lifecycle can auto-submit / auto-approve. Exposes HR knobs (backgroundCheckRequired, anonymizeOnRejection, …).
 *
 ...
 */
export type StdTimeEntryEventKey = 'CLOSE_VIEW' | 'INIT' | 'OPEN_ENTRY' | 'REQUEST_DELETE' | 'SET_STATUS' | 'TimeEntryLoadFailed' | 'TimeEntryLoaded';
