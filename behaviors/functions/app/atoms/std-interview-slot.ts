/**
 * std-interview-slot — std-interview-slot — scheduled interview between applicant and interviewers. Listens for SET_STATUS so sibling std-lifecycle can drive automated transitions. Exposes Scheduling/Booking + HR knobs (bookingWindowDays, leadTimeMinutes, backgroundCheckRequired, …).
 *
 ...
 */
export type StdInterviewSlotEventKey = 'CANCEL_INTERVIEW' | 'CLOSE_VIEW' | 'COMPLETE_INTERVIEW' | 'INIT' | 'InterviewSlotLoadFailed' | 'InterviewSlotLoaded' | 'OPEN_INTERVIEW' | 'SET_STATUS';
