/**
 * std-applicant — std-applicant — job applicant pipeline (stage field, not status). Exposes HR knobs (backgroundCheckRequired, eVerifyRequired, anonymizeOnRejection, …).
 *
