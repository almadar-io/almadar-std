 ...
 *   node scripts/regenerate-std-ts.mjs --only=std-timeline
 *
 * @level molecule
...
const BEHAVIOR_PATH = 'std/behaviors/std-timeline';
const ALIAS = 'Timeline';
 ...
 */
export interface StdTimelineConfig {
  formFields?: TraitConfig;
}

/**
 * Params for the std-timeline descriptor helpers.
 *
 ...
 */
export interface StdTimelineParams {
  entityName: string;
  ...
  config?: StdTimelineConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `Timeline.traits.TimelineFeed`. */
export function stdTimelineTrait(params: StdTimelineParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.TimelineFeed`,
...
/** Page descriptor: `Timeline.pages.TimelinePage`. */
export function stdTimelinePage(params: StdTimelineParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.TimelinePage`,
...
export function stdTimeline(params: StdTimelineParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdTimelineTrait(params),
    ],
    pages: [
      stdTimelinePage(params),
    ],
  });
}
