/**
 * std-cart — std-cart — shopping cart molecule composing CartItemCartBrowse + Modal-driven add + Confirmation-driven remove + persistor coordinator.
 *
 * Autogenerated by scripts/regenerate-std-ts.mjs from
 * packages/almadar-std/behaviors/registry/molecules/std-cart.orb.
 *
 ...
 *   node scripts/regenerate-std-ts.mjs --only=std-cart
 *
 * @level molecule
...
const BEHAVIOR_PATH = 'std/behaviors/std-cart';
const ALIAS = 'Cart';
...
/** Trait descriptor: `Cart.traits.CartItemCartBrowse`. */
export function stdCartCartItemCartBrowseTrait(params: StdCartParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
...
/** Trait descriptor: `Cart.traits.CartItemAddItem`. */
export function stdCartCartItemAddItemTrait(params: StdCartParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
...
/** Trait descriptor: `Cart.traits.CartItemRemoveConfirm`. */
export function stdCartCartItemRemoveConfirmTrait(params: StdCartParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
...
/** Trait descriptor: `Cart.traits.CartItemPersistor`. */
export function stdCartCartItemPersistorTrait(params: StdCartParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
...
/** Page descriptor: `Cart.pages.CartItemPage`. */
export function stdCartPage(params: StdCartParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.CartItemPage`,
...
export function stdCart(params: StdCartParams): OrbitalDefinition {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdCartCartItemCartBrowseTrait(params),
      stdCartCartItemAddItemTrait(params),
      stdCartCartItemRemoveConfirmTrait(params),
      stdCartCartItemPersistorTrait(params),
    ],
    pages: [
      stdCartPage(params),
    ],
