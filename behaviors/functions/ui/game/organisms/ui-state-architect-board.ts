/**
 * ui-state-architect-board — StateArchitectBoard — UI factory (1:1 with the @almadar/ui state-architect-board pattern).
 *
 ...
 */
export type StdUiStateArchitectBoardEventKey = 'COMPLETE' | 'INIT' | 'TEST';

/**
 * Payload shape for the `TEST` event.
 */
export interface StdUiStateArchitectBoardTestPayload {
  id?: string;
}
