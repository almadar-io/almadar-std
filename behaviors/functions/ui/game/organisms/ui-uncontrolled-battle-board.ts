...
export interface StdUiUncontrolledBattleBoardConfig {
  ...
  features?: EntityRow[];
  /** Default: `[{"atk":5,"def":2,"hp":20,"id":"u1","maxHp":20,"modelUrl":"https://almadar-kflow-assets.web.app/shared/models/characters/pit_slave.glb","name":"Warrior","position":{"x":1,"y":2},"team":"player","unitType":"warrior"},{"atk":4,"def":1,"hp":15,"id":"u2","maxHp":15,"modelUrl":"https://almadar-kflow-assets.web.app/shared/models/characters/shadow_legionnaire.glb","name":"Shadow","position":{"x":3,"y":2},"team":"enemy","unitType":"guardian"}]` */
