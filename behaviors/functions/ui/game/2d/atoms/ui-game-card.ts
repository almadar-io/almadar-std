/**
 * ui-game-card — GameCard — UI factory (1:1 with the @almadar/ui game-card pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/ui-game-card.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-game-card
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/ui-game-card';
const ALIAS = 'UiGameCard';
 ...
 */
export type StdUiGameCardEventKey = 'CLICK' | 'INIT';

/**
 * Payload shape for the `CLICK` event.
 */
export interface StdUiGameCardClickPayload {
  id?: string;
  cardId: string;
}
...
/**
 * Params for the ui-game-card descriptor helpers.
 *
 ...
 */
export interface StdUiGameCardParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiGameCardEventKey, string>>;
  ...
  config?: StdUiGameCardConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiGameCard.traits.GameCardRender`. */
export function stdUiGameCardTrait(params: StdUiGameCardParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.GameCardRender`,
...
/** Page descriptor: `UiGameCard.pages.GameCardPage`. */
export function stdUiGameCardPage(params: StdUiGameCardParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.GameCardPage`,
...
export function stdUiGameCard(params: StdUiGameCardParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'GameCardOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiGameCardTrait(params),
    ],
    pages: [
      stdUiGameCardPage(params),
    ],
  });
}
