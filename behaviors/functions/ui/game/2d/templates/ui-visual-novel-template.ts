/**
 * ui-visual-novel-template — VisualNovelTemplate — thin playable shell; renders visual-novel-board descriptor matching ui-visual-novel-board.
 *
 ...
 */
export type StdUiVisualNovelTemplateEventKey = 'ADVANCE' | 'CHOOSE' | 'INIT' | 'RESTART';

/**
 * Payload shape for the `CHOOSE` event.
 */
export interface StdUiVisualNovelTemplateChoosePayload {
  nextId?: string;
}
