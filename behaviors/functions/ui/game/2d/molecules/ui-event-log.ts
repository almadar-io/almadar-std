 ...
 * packages/almadar-std/behaviors/registry/molecules/ui-event-log.orb.
 *
...
/**
 * Params for the ui-event-log descriptor helpers.
 *
...
export interface StdUiEventLogParams {
  ...
  events?: Partial<Record<StdUiEventLogEventKey, string>>;
  ...
  config?: StdUiEventLogConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiEventLog.traits.EventLogRender`. */
export function stdUiEventLogTrait(params: StdUiEventLogParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.EventLogRender`,
...
/** Page descriptor: `UiEventLog.pages.EventLogPage`. */
export function stdUiEventLogPage(params: StdUiEventLogParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
...
export function stdUiEventLog(params: StdUiEventLogParams): OrbitalDefinition {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdUiEventLogTrait(params),
    ],
    pages: [
      stdUiEventLogPage(params),
    ],
  });
}
