/**
 * ui-score-board — ScoreBoard — UI factory (1:1 with the @almadar/ui score-board pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/molecules/ui-score-board.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-score-board
 *
 * @level molecule
...
const BEHAVIOR_PATH = 'std/behaviors/ui-score-board';
const ALIAS = 'UiScoreBoard';
 ...
 */
export type StdUiScoreBoardEventKey = 'INIT';
...
/**
 * Params for the ui-score-board descriptor helpers.
 *
 ...
 */
export interface StdUiScoreBoardParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiScoreBoardEventKey, string>>;
  ...
  config?: StdUiScoreBoardConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiScoreBoard.traits.ScoreBoardRender`. */
export function stdUiScoreBoardTrait(params: StdUiScoreBoardParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.ScoreBoardRender`,
...
/** Page descriptor: `UiScoreBoard.pages.ScoreBoardPage`. */
export function stdUiScoreBoardPage(params: StdUiScoreBoardParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.ScoreBoardPage`,
...
export function stdUiScoreBoard(params: StdUiScoreBoardParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdUiScoreBoardTrait(params),
    ],
    pages: [
      stdUiScoreBoardPage(params),
    ],
  });
}
