...
export interface StdUiCastleTemplateConfig {
  ...
  tiles?: EntityRow[];
  /** Default: `[{"health":10,"id":"u1","maxHealth":10,"name":"Worker","position":{"x":1,"y":1},"sprite":"https://almadar-kflow-assets.web.app/shared/sprite-sheets/coordinator-sprite-sheet-se.png","team":"player","unitType":"worker"},{"health":10,"id":"u2","maxHealth":10,"name":"Guardian","position":{"x":3,"y":3},"sprite":"https://almadar-kflow-assets.web.app/shared/sprite-sheets/forger-sprite-sheet-se.png","team":"player","unitType":"guardian"}]` */
  units?: EntityRow[];
}
