...
export interface StdUiWorldMapTemplateConfig {
  ...
  /** Default: `2.5` */
  unitScale?: number;
  /** Default: `[{"health":10,"id":"u1","maxHealth":10,"name":"Worker","position":{"x":1,"y":1},"sprite":"https://almadar-kflow-assets.web.app/shared/sprite-sheets/amir-sprite-sheet-se.png","team":"player","unitType":"worker"},{"health":8,"id":"u2","maxHealth":10,"name":"Guardian","position":{"x":3,"y":3},"sprite":"https://almadar-kflow-assets.web.app/shared/sprite-sheets/shadow-legion-sprite-sheet-se.png","team":"enemy","unitType":"guardian"}]` */
  units?: EntityRow[];
}
