/**
 * ui-d-pad — DPad — UI factory (1:1 with the @almadar/ui d-pad pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/molecules/ui-d-pad.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-d-pad
 *
 * @level molecule
...
const BEHAVIOR_PATH = 'std/behaviors/ui-d-pad';
const ALIAS = 'UiDPad';
 ...
 */
export type StdUiDPadEventKey = 'DIRECTION' | 'INIT';

/**
 * Payload shape for the `DIRECTION` event.
 */
export interface StdUiDPadDirectionPayload {
  direction?: string;
  pressed?: boolean;
}
...
/**
 * Params for the ui-d-pad descriptor helpers.
 *
 ...
 */
export interface StdUiDPadParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiDPadEventKey, string>>;
  ...
  config?: StdUiDPadConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiDPad.traits.DPadRender`. */
export function stdUiDPadTrait(params: StdUiDPadParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.DPadRender`,
...
/** Page descriptor: `UiDPad.pages.DPadPage`. */
export function stdUiDPadPage(params: StdUiDPadParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.DPadPage`,
...
export function stdUiDPad(params: StdUiDPadParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdUiDPadTrait(params),
    ],
    pages: [
      stdUiDPadPage(params),
    ],
  });
}
