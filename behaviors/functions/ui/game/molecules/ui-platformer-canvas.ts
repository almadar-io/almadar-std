/**
 * ui-platformer-canvas — PlatformerCanvas — model-authoritative platformer physics; 33ms tick owns gravity+integration+AABB collision; canvas interpolates from player/platforms props.
 *
...
export interface StdUiPlatformerCanvasConfig {
  ...
  /** Default: `"https://almadar-kflow-assets.web.app/shared/ui-platformer-board/default/terrain/ground.png"` */
  ...
  /** Default: `4` */
  moveSpeed?: number;
  /** Default: `[{"height":32,"type":"ground","width":800,"x":0,"y":368},{"height":16,"type":"platform","width":160,"x":150,"y":280},{"height":16,"type":"platform","width":160,"x":420,"y":220},{"height":16,"type":"platform","width":140,"x":620,"y":300}]` */
  platforms?: EntityRow[];
