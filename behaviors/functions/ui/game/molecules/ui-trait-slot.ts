...
export interface StdUiTraitSlotConfig {
  ...
  /** Default: `1` */
  slotNumber?: number;
  /** Default: `{"animations":["idle","walk","attack","hit","death"],"aspect":"1:1","category":"tooltipFrameUrl","dimension":"2d","name":"tooltipFrameUrl","role":"npc","style":"pixel","thumbnailUrl":"","url":"https://almadar-kflow-assets.web.app/shared/ui-roguelike-board/default/units/player.png"}` */
