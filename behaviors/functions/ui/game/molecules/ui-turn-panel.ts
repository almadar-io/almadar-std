/**
 * ui-turn-panel — TurnPanel — UI factory (1:1 with the @almadar/ui turn-panel pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/molecules/ui-turn-panel.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-turn-panel
 *
 * @level molecule
...
const BEHAVIOR_PATH = 'std/behaviors/ui-turn-panel';
const ALIAS = 'UiTurnPanel';
 ...
 */
export type StdUiTurnPanelEventKey = 'INIT';
...
export interface StdUiTurnPanelConfig {
  ...
  /** Default: `"Phase"` */
  phase?: string;
  /** Default: `[{"label":"Label","disabled":false,"icon":"circle"}]` */
  actions?: EntityRow[];
}

/**
 * Params for the ui-turn-panel descriptor helpers.
 *
 ...
 */
export interface StdUiTurnPanelParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiTurnPanelEventKey, string>>;
  ...
  config?: StdUiTurnPanelConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiTurnPanel.traits.TurnPanelRender`. */
export function stdUiTurnPanelTrait(params: StdUiTurnPanelParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.TurnPanelRender`,
...
/** Page descriptor: `UiTurnPanel.pages.TurnPanelPage`. */
export function stdUiTurnPanelPage(params: StdUiTurnPanelParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.TurnPanelPage`,
...
export function stdUiTurnPanel(params: StdUiTurnPanelParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'TurnPanelOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiTurnPanelTrait(params),
    ],
    pages: [
      stdUiTurnPanelPage(params),
    ],
  });
}
