/**
 * ui-game-over-screen — GameOverScreen — UI factory (1:1 with the @almadar/ui game-over-screen pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/molecules/ui-game-over-screen.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-game-over-screen
 *
 * @level molecule
...
const BEHAVIOR_PATH = 'std/behaviors/ui-game-over-screen';
const ALIAS = 'UiGameOverScreen';
 ...
 */
export type StdUiGameOverScreenEventKey = 'ACTION' | 'INIT';

/**
 * Payload shape for the `ACTION` event.
 */
export interface StdUiGameOverScreenActionPayload {
  action?: EntityRow;
}
...
export interface StdUiGameOverScreenConfig {
  ...
  currentScore?: string;
  /** Default: `[{"value":"Value","label":"Label","bind":"Bind","format":"number","icon":"circle"}]` */
  stats?: EntityRow[];
  /** Default: `[{"variant":"primary","label":"Label","navigatesTo":"Navigates To"}]` */
  menuItems?: EntityRow[];
  /** Default: `"High Score"` */
...
/**
 * Params for the ui-game-over-screen descriptor helpers.
 *
 ...
 */
export interface StdUiGameOverScreenParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiGameOverScreenEventKey, string>>;
  ...
  config?: StdUiGameOverScreenConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiGameOverScreen.traits.GameOverScreenRender`. */
export function stdUiGameOverScreenTrait(params: StdUiGameOverScreenParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.GameOverScreenRender`,
...
/** Page descriptor: `UiGameOverScreen.pages.GameOverScreenPage`. */
export function stdUiGameOverScreenPage(params: StdUiGameOverScreenParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.GameOverScreenPage`,
...
export function stdUiGameOverScreen(params: StdUiGameOverScreenParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdUiGameOverScreenTrait(params),
    ],
    pages: [
      stdUiGameOverScreenPage(params),
    ],
  });
}
