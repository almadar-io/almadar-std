/**
 * ui-dialogue-bubble — DialogueBubble — UI factory (1:1 with the @almadar/ui dialogue-bubble pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/ui-dialogue-bubble.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-dialogue-bubble
 *
 * @level atom
 ...
 */
export type StdUiDialogueBubbleEventKey = 'INIT';
...
export interface StdUiDialogueBubbleConfig {
  /** Default: `""` */
  className?: string;
  /** Default: `"https://almadar-kflow-assets.web.app/shared/units/chars-toon/trait-wars/citizens/archetypes/04_hero.png"` */
  portrait?: unknown;
  /** Default: `"bottom"` */
  position?: 'top' | 'bottom';
  /** Default: `"Hero"` */
...
/**
 * Params for the ui-dialogue-bubble descriptor helpers.
 *
 ...
 */
export interface StdUiDialogueBubbleParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiDialogueBubbleEventKey, string>>;
  ...
  config?: StdUiDialogueBubbleConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiDialogueBubble.traits.DialogueBubbleRender`. */
export function stdUiDialogueBubbleTrait(params: StdUiDialogueBubbleParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.DialogueBubbleRender`,
...
/** Page descriptor: `UiDialogueBubble.pages.DialogueBubblePage`. */
export function stdUiDialogueBubblePage(params: StdUiDialogueBubbleParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.DialogueBubblePage`,
...
export function stdUiDialogueBubble(params: StdUiDialogueBubbleParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'DialogueBubbleOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiDialogueBubbleTrait(params),
    ],
    pages: [
      stdUiDialogueBubblePage(params),
    ],
  });
}
