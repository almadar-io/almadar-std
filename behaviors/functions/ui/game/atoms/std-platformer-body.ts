 ...
 */
export type StdPlatformerBodyEventKey = 'BODY_FELL' | 'BODY_GOAL' | 'BODY_HAZARD' | 'BODY_JUMPED' | 'BODY_LANDED' | 'BODY_MOVED' | 'BODY_SKATE_END' | 'BODY_SKATE_START' | 'INIT' | 'JUMP' | 'PLACE' | 'RESTART' | 'STEER';
