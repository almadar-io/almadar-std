 ...
 */
export type StdPlatformerBodyEventKey = 'BODY_FELL' | 'BODY_GOAL' | 'BODY_HAZARD' | 'BODY_JUMPED' | 'BODY_LANDED' | 'BODY_MOVED' | 'BODY_SKATE_END' | 'BODY_SKATE_START' | 'CURVE_MOD_ADD' | 'CURVE_MOD_CLEAR' | 'CURVE_MOD_CLEAR_RANGE' | 'INIT' | 'JUMP' | 'PLACE' | 'RESTART' | 'SET_DRIFT_REGIONS' | 'SET_PLATFORMS' | 'SET_SKATE_CURVE' | 'SET_TUNING' | 'STEER';
