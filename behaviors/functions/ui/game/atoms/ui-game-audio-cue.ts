/**
 * ui-game-audio-cue — GameAudioCue — UI factory (1:1 with the @almadar/ui game-audio-cue pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/ui-game-audio-cue.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-game-audio-cue
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/ui-game-audio-cue';
const ALIAS = 'UiGameAudioCue';
 ...
 */
export type StdUiGameAudioCueEventKey = 'INIT';
 ...
 */
export interface StdUiGameAudioCueConfig {
  baseUrl?: string;
  cue?: string;
  cueSeq?: number;
  /** Default: `{}` */
...
/**
 * Params for the ui-game-audio-cue descriptor helpers.
 *
 ...
 */
export interface StdUiGameAudioCueParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiGameAudioCueEventKey, string>>;
  ...
  config?: StdUiGameAudioCueConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiGameAudioCue.traits.GameAudioCueRender`. */
export function stdUiGameAudioCueTrait(params: StdUiGameAudioCueParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.GameAudioCueRender`,
...
/** Page descriptor: `UiGameAudioCue.pages.GameAudioCuePage`. */
export function stdUiGameAudioCuePage(params: StdUiGameAudioCueParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.GameAudioCuePage`,
...
export function stdUiGameAudioCue(params: StdUiGameAudioCueParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdUiGameAudioCueTrait(params),
    ],
    pages: [
      stdUiGameAudioCuePage(params),
    ],
  });
}
