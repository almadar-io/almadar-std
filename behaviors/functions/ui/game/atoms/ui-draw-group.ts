 ...
 * packages/almadar-std/behaviors/registry/atoms/ui-draw-group.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-draw-group
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/ui-draw-group';
const ALIAS = 'UiDrawGroup';
 ...
 */
export type StdUiDrawGroupEventKey = 'INIT';
...
/**
 * Params for the ui-draw-group descriptor helpers.
 *
 ...
 */
export interface StdUiDrawGroupParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiDrawGroupEventKey, string>>;
  ...
  config?: StdUiDrawGroupConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiDrawGroup.traits.DrawGroupRender`. */
export function stdUiDrawGroupTrait(params: StdUiDrawGroupParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.DrawGroupRender`,
...
/** Page descriptor: `UiDrawGroup.pages.DrawGroupPage`. */
export function stdUiDrawGroupPage(params: StdUiDrawGroupParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.DrawGroupPage`,
...
export function stdUiDrawGroup(params: StdUiDrawGroupParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdUiDrawGroupTrait(params),
    ],
    pages: [
      stdUiDrawGroupPage(params),
    ],
  });
}
