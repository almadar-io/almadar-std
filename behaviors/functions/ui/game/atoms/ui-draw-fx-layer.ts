...
const BEHAVIOR_PATH = 'std/behaviors/ui-draw-fx-layer';
const ALIAS = 'UiDrawFxLayer';
 ...
 */
export type StdUiDrawFxLayerEventKey = 'INIT';
 ...
 */
export interface StdUiDrawFxLayerParams {
  entityName: string;
...
export function stdUiDrawFxLayerTrait(params: StdUiDrawFxLayerParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.DrawFxLayerRender`,
...
export function stdUiDrawFxLayerPage(params: StdUiDrawFxLayerParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.DrawFxLayerPage`,
...
export function stdUiDrawFxLayer(params: StdUiDrawFxLayerParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdUiDrawFxLayerTrait(params),
    ],
    pages: [
      stdUiDrawFxLayerPage(params),
    ],
  });
}
