 ...
 */
export type StdTutorialOverlayEventKey = 'INIT' | 'SHOW' | 'TUTORIAL_DONE' | 'TUT_AUTO' | 'TUT_BACK' | 'TUT_DISMISS' | 'TUT_NEXT';

/**
 * Payload shape for the `TUT_AUTO` event.
 */
export interface StdTutorialOverlayTutAutoPayload {
  id?: string;
}
 ...
 */
export interface StdTutorialOverlayTutNextPayload {
  id?: string;
}
 ...
 */
export interface StdTutorialOverlayTutBackPayload {
  id?: string;
}
 ...
 */
export interface StdTutorialOverlayTutDismissPayload {
  id?: string;
}
 ...
 */
export interface StdTutorialOverlayShowPayload {
  id?: string;
}
 ...
 */
export interface StdTutorialOverlayTutorialDonePayload {
  id: string;
}
 ...
 */
export interface StdTutorialOverlayConfig {
  /** Default: `true` */
  autoShow?: boolean;
  /** Default: `[]` */
  steps?: EntityRow[];
...
export function stdTutorialOverlayTrait(params: StdTutorialOverlayParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
...
export function stdTutorialOverlay(params: StdTutorialOverlayParams): OrbitalDefinition {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdTutorialOverlayTrait(params),
    ],
    pages: [
