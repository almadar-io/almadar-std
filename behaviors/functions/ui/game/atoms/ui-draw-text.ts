/**
 * ui-draw-text — DrawText — UI factory (1:1 with the @almadar/ui draw-text pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/ui-draw-text.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-draw-text
 *
 * @level atom
 ...
 */
export type StdUiDrawTextEventKey = 'INIT';
...
/**
 * Params for the ui-draw-text descriptor helpers.
 *
 ...
 */
export interface StdUiDrawTextParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiDrawTextEventKey, string>>;
  ...
  config?: StdUiDrawTextConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiDrawText.traits.DrawTextRender`. */
export function stdUiDrawTextTrait(params: StdUiDrawTextParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.DrawTextRender`,
...
/** Page descriptor: `UiDrawText.pages.DrawTextPage`. */
export function stdUiDrawTextPage(params: StdUiDrawTextParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.DrawTextPage`,
...
export function stdUiDrawText(params: StdUiDrawTextParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'DrawTextOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiDrawTextTrait(params),
    ],
    pages: [
      stdUiDrawTextPage(params),
    ],
  });
}
