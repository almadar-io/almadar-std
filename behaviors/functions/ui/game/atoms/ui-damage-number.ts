/**
 * ui-damage-number — DamageNumber — UI factory (1:1 with the @almadar/ui damage-number pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/ui-damage-number.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-damage-number
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/ui-damage-number';
const ALIAS = 'UiDamageNumber';
 ...
 */
export type StdUiDamageNumberEventKey = 'INIT';
...
/**
 * Params for the ui-damage-number descriptor helpers.
 *
 ...
 */
export interface StdUiDamageNumberParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiDamageNumberEventKey, string>>;
  ...
  config?: StdUiDamageNumberConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiDamageNumber.traits.DamageNumberRender`. */
export function stdUiDamageNumberTrait(params: StdUiDamageNumberParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.DamageNumberRender`,
...
/** Page descriptor: `UiDamageNumber.pages.DamageNumberPage`. */
export function stdUiDamageNumberPage(params: StdUiDamageNumberParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.DamageNumberPage`,
...
export function stdUiDamageNumber(params: StdUiDamageNumberParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'DamageNumberOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiDamageNumberTrait(params),
    ],
    pages: [
      stdUiDamageNumberPage(params),
    ],
  });
}
