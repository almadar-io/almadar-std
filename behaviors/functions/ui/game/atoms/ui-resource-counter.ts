/**
 * ui-resource-counter — ResourceCounter — UI factory (1:1 with the @almadar/ui resource-counter pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/ui-resource-counter.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-resource-counter
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/ui-resource-counter';
const ALIAS = 'UiResourceCounter';
 ...
 */
export type StdUiResourceCounterEventKey = 'INIT';
...
/**
 * Params for the ui-resource-counter descriptor helpers.
 *
 ...
 */
export interface StdUiResourceCounterParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiResourceCounterEventKey, string>>;
  ...
  config?: StdUiResourceCounterConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiResourceCounter.traits.ResourceCounterRender`. */
export function stdUiResourceCounterTrait(params: StdUiResourceCounterParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.ResourceCounterRender`,
...
/** Page descriptor: `UiResourceCounter.pages.ResourceCounterPage`. */
export function stdUiResourceCounterPage(params: StdUiResourceCounterParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.ResourceCounterPage`,
...
export function stdUiResourceCounter(params: StdUiResourceCounterParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'ResourceCounterOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiResourceCounterTrait(params),
    ],
    pages: [
      stdUiResourceCounterPage(params),
    ],
  });
}
