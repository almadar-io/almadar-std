/**
 * ui-draw-mesh — DrawMesh — UI factory (1:1 with the @almadar/ui draw-mesh pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/ui-draw-mesh.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-draw-mesh
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/ui-draw-mesh';
const ALIAS = 'UiDrawMesh';
 ...
 */
export type StdUiDrawMeshEventKey = 'INIT';
 ...
 */
export interface StdUiDrawMeshConfig {
  animation?: EntityRow;
  castShadow?: boolean;
  depth?: number;
  /** Default: `[]` */
...
/**
 * Params for the ui-draw-mesh descriptor helpers.
 *
 ...
 */
export interface StdUiDrawMeshParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiDrawMeshEventKey, string>>;
  ...
  config?: StdUiDrawMeshConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiDrawMesh.traits.DrawMeshRender`. */
export function stdUiDrawMeshTrait(params: StdUiDrawMeshParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.DrawMeshRender`,
...
/** Page descriptor: `UiDrawMesh.pages.DrawMeshPage`. */
export function stdUiDrawMeshPage(params: StdUiDrawMeshParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.DrawMeshPage`,
...
export function stdUiDrawMesh(params: StdUiDrawMeshParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'DrawMeshOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiDrawMeshTrait(params),
    ],
    pages: [
      stdUiDrawMeshPage(params),
    ],
  });
}
