/**
 * ui-mini-map — MiniMap — UI factory (1:1 with the @almadar/ui mini-map pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/ui-mini-map.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-mini-map
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/ui-mini-map';
const ALIAS = 'UiMiniMap';
 ...
 */
export type StdUiMiniMapEventKey = 'INIT';
...
export interface StdUiMiniMapConfig {
  /** Default: `[{"x":1,"y":1,"color":"Color"}]` */
  tiles?: EntityRow[];
  /** Default: `[{"color":"Color","x":1,"y":1,"isPlayer":false}]` */
  units?: EntityRow[];
  /** Default: `100` */
  mapWidth?: number;
  /** Default: `150` */
...
/**
 * Params for the ui-mini-map descriptor helpers.
 *
 ...
 */
export interface StdUiMiniMapParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiMiniMapEventKey, string>>;
  ...
  config?: StdUiMiniMapConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiMiniMap.traits.MiniMapRender`. */
export function stdUiMiniMapTrait(params: StdUiMiniMapParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.MiniMapRender`,
...
/** Page descriptor: `UiMiniMap.pages.MiniMapPage`. */
export function stdUiMiniMapPage(params: StdUiMiniMapParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.MiniMapPage`,
...
export function stdUiMiniMap(params: StdUiMiniMapParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdUiMiniMapTrait(params),
    ],
    pages: [
      stdUiMiniMapPage(params),
    ],
  });
}
