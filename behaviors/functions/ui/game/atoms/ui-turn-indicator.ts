/**
 * ui-turn-indicator — TurnIndicator — UI factory (1:1 with the @almadar/ui turn-indicator pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/ui-turn-indicator.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-turn-indicator
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/ui-turn-indicator';
const ALIAS = 'UiTurnIndicator';
 ...
 */
export type StdUiTurnIndicatorEventKey = 'INIT';
...
/**
 * Params for the ui-turn-indicator descriptor helpers.
 *
 ...
 */
export interface StdUiTurnIndicatorParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiTurnIndicatorEventKey, string>>;
  ...
  config?: StdUiTurnIndicatorConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiTurnIndicator.traits.TurnIndicatorRender`. */
export function stdUiTurnIndicatorTrait(params: StdUiTurnIndicatorParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.TurnIndicatorRender`,
...
/** Page descriptor: `UiTurnIndicator.pages.TurnIndicatorPage`. */
export function stdUiTurnIndicatorPage(params: StdUiTurnIndicatorParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.TurnIndicatorPage`,
...
export function stdUiTurnIndicator(params: StdUiTurnIndicatorParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'TurnIndicatorOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiTurnIndicatorTrait(params),
    ],
    pages: [
      stdUiTurnIndicatorPage(params),
    ],
  });
}
