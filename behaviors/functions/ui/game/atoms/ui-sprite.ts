/**
 * ui-sprite — Sprite — UI factory (1:1 with the @almadar/ui sprite pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/ui-sprite.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-sprite
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/ui-sprite';
const ALIAS = 'UiSprite';
 ...
 */
export type StdUiSpriteEventKey = 'ACTION' | 'CLICK' | 'INIT';

/**
 * Payload shape for the `CLICK` event.
 */
export interface StdUiSpriteClickPayload {
  id?: string;
}
 ...
 */
export interface StdUiSpriteActionPayload {
  id?: string;
}
...
/**
 * Params for the ui-sprite descriptor helpers.
 *
 ...
 */
export interface StdUiSpriteParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiSpriteEventKey, string>>;
  ...
  config?: StdUiSpriteConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiSprite.traits.SpriteRender`. */
export function stdUiSpriteTrait(params: StdUiSpriteParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.SpriteRender`,
...
/** Page descriptor: `UiSprite.pages.SpritePage`. */
export function stdUiSpritePage(params: StdUiSpriteParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.SpritePage`,
...
export function stdUiSprite(params: StdUiSpriteParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdUiSpriteTrait(params),
    ],
    pages: [
      stdUiSpritePage(params),
    ],
  });
}
