/**
 * ui-math-canvas — MathCanvas — UI factory (1:1 with the @almadar/ui math-canvas pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/molecules/ui-math-canvas.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-math-canvas
 *
 * @level molecule
 ...
 */
export interface StdUiMathCanvasShapeClickPayload {
  payload?: EntityRow;
}
...
/**
 * Params for the ui-math-canvas descriptor helpers.
 *
 ...
 */
export interface StdUiMathCanvasParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiMathCanvasEventKey, string>>;
  ...
  config?: StdUiMathCanvasConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiMathCanvas.traits.MathCanvasRender`. */
export function stdUiMathCanvasTrait(params: StdUiMathCanvasParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.MathCanvasRender`,
...
/** Page descriptor: `UiMathCanvas.pages.MathCanvasPage`. */
export function stdUiMathCanvasPage(params: StdUiMathCanvasParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.MathCanvasPage`,
...
export function stdUiMathCanvas(params: StdUiMathCanvasParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'MathCanvasOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiMathCanvasTrait(params),
    ],
    pages: [
      stdUiMathCanvasPage(params),
    ],
  });
}
