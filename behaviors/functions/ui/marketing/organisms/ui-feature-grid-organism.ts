/**
 * ui-feature-grid-organism — FeatureGridOrganism — UI factory (1:1 with the @almadar/ui feature-grid-organism pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/organisms/ui-feature-grid-organism.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-feature-grid-organism
 *
 * @level organism
...
const BEHAVIOR_PATH = 'std/behaviors/ui-feature-grid-organism';
const ALIAS = 'UiFeatureGridOrganism';
 ...
 *
 * Canonical entity: FeatureGridOrganismItem — overridable via
 ...
 */
export interface StdUiFeatureGridOrganismFeatureGridOrganismOrbitalParams {
...
export function stdUiFeatureGridOrganismFeatureGridOrganismOrbital(params: StdUiFeatureGridOrganismFeatureGridOrganismOrbitalParams = {}): OrbitalDefinition {
  const canonicalName = params.entityName ?? 'FeatureGridOrganismItem';
  const built = makeOrbitalWithUses({
    name: 'FeatureGridOrganismOrbital',
    uses: [],
    entity: {
      name: canonicalName,
      persistence: 'runtime',
    ...
    traits: [
      rebindInlineTraitEntity({
        ...
        'emits': [
          {
            ...
            'eventId': asEventId('evt_01KXG05573NCFB3BMV5Y48Z7QN'),
            'payloadSchema': [
              {
                'name': 'data',
        ...
        'id': asTraitId('trt_01KXG05571C7GGBJYQHHF1Q6ZR'),
        'linkedEntity': 'FeatureGridOrganismItem',
        'linkedEntityId': asEntityId('ent_01KXG05571CSVGWFFDX7ZECC6D'),
        'name': 'FeatureGridOrganismRender',
        'scope': 'instance',
        'stateMachine': {
          'events': [
            {
    ...
    pages: [
      {
        'id': asPageId('pag_01KXG055732AQ9EXTQ36WMGHYA'),
        'name': 'FeatureGridOrganismPage',
        'path': '/feature-grid-organism',
        'traits': [
          {
            'ref': 'FeatureGridOrganismRender',
            'refId': asTraitId('trt_01KXG05571C7GGBJYQHHF1Q6ZR'),
          },
        ],
      } satisfies Page,
    ],
...
/** Manifest — describes the params surface of stdUiFeatureGridOrganismFeatureGridOrganismOrbital. */
export const StdUiFeatureGridOrganismFeatureGridOrganismOrbitalManifest = {
  organism: 'ui-feature-grid-organism',
  orbitalName: 'FeatureGridOrganismOrbital',
  paramFields: [
...
/** Typed guard — runtime validates StdUiFeatureGridOrganismFeatureGridOrganismOrbitalParams keys. */
export function isStdUiFeatureGridOrganismFeatureGridOrganismOrbitalParams(p: object): p is StdUiFeatureGridOrganismFeatureGridOrganismOrbitalParams {
  type _OverrideRecord = NonNullable<StdUiFeatureGridOrganismFeatureGridOrganismOrbitalParams['traitOverrides']>;
  const obj = p as { traitOverrides?: _OverrideRecord };
  if (obj.traitOverrides !== undefined) {
    if (typeof obj.traitOverrides !== "object" || obj.traitOverrides === null) return false;
    const allowed: readonly string[] = [
      ...StdUiFeatureGridOrganismFeatureGridOrganismOrbitalManifest.traitNames,
      ...StdUiFeatureGridOrganismFeatureGridOrganismOrbitalManifest.inlineTraitNames,
    ];
...
/**
 * Bundled params for ui-feature-grid-organism — one optional entry per orbital.
 * Each entry maps to its per-orbital factory above.
 */
export interface StdUiFeatureGridOrganismParams {
  FeatureGridOrganism?: StdUiFeatureGridOrganismFeatureGridOrganismOrbitalParams;
}

/** Whole-organism descriptor (1 orbitals). Composes per-orbital factories. */
export function stdUiFeatureGridOrganism(params: StdUiFeatureGridOrganismParams = {}): OrbitalDefinition[] {
  return [
    stdUiFeatureGridOrganismFeatureGridOrganismOrbital(params.FeatureGridOrganism ?? {}),
  ];
}
