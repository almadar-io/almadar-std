/**
 * ui-book-viewer — BookViewer — UI factory (1:1 with the @almadar/ui book-viewer pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/organisms/ui-book-viewer.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-book-viewer
 *
 * @level organism
...
export interface StdUiBookViewerConfig {
  ...
  className?: string;
  error?: EntityRow;
  /** Default: `{"author":"Author","chapterContent":"Chapter Content","chapterId":"Chapter Id","chapterOrbitalSchema":"Chapter Orbital Schema","chapterTitle":"Chapter Title","chapters":"Chapters","coverImageUrl":"Cover Image Url","direction":"Direction","partTitle":"Part Title","parts":"Parts","subtitle":"Subtitle","title":"Title"}` */
  fieldMap?: EntityRow;
  /** Default: `0` */
  initialPage?: number;
  /** Default: `false` */
 ...
 *
 * Canonical entity: BookViewerItem — overridable via
 ...
 */
export interface StdUiBookViewerBookViewerOrbitalParams {
        ...
        'config': {
          ...
          'fieldMap': {
            'default': {
              ...
              'chapterOrbitalSchema': 'Chapter Orbital Schema',
...
/** Manifest — describes the params surface of stdUiBookViewerBookViewerOrbital. */
export const StdUiBookViewerBookViewerOrbitalManifest = {
  organism: 'ui-book-viewer',
  orbitalName: 'BookViewerOrbital',
  paramFields: [
...
/** Typed guard — runtime validates StdUiBookViewerBookViewerOrbitalParams keys. */
export function isStdUiBookViewerBookViewerOrbitalParams(p: object): p is StdUiBookViewerBookViewerOrbitalParams {
  type _OverrideRecord = NonNullable<StdUiBookViewerBookViewerOrbitalParams['traitOverrides']>;
  const obj = p as { traitOverrides?: _OverrideRecord };
  if (obj.traitOverrides !== undefined) {
    if (typeof obj.traitOverrides !== "object" || obj.traitOverrides === null) return false;
    const allowed: readonly string[] = [
      ...StdUiBookViewerBookViewerOrbitalManifest.traitNames,
      ...StdUiBookViewerBookViewerOrbitalManifest.inlineTraitNames,
    ];
...
/**
 * Bundled params for ui-book-viewer — one optional entry per orbital.
 * Each entry maps to its per-orbital factory above.
 */
export interface StdUiBookViewerParams {
  BookViewer?: StdUiBookViewerBookViewerOrbitalParams;
}

/** Whole-organism descriptor (1 orbitals). Composes per-orbital factories. */
export function stdUiBookViewer(params: StdUiBookViewerParams = {}): OrbitalDefinition[] {
  return [
    stdUiBookViewerBookViewerOrbital(params.BookViewer ?? {}),
  ];
}
