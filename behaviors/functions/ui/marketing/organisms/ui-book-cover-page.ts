/**
 * ui-book-cover-page — BookCoverPage — UI factory (1:1 with the @almadar/ui book-cover-page pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/organisms/ui-book-cover-page.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-book-cover-page
 *
 * @level organism
 ...
 */
export type StdUiBookCoverPageEventKey = 'INIT';
 ...
 *
 * Canonical entity: BookCoverPageItem — overridable via
 ...
 */
export interface StdUiBookCoverPageBookCoverPageOrbitalParams {
...
/** Manifest — describes the params surface of stdUiBookCoverPageBookCoverPageOrbital. */
export const StdUiBookCoverPageBookCoverPageOrbitalManifest = {
  organism: 'ui-book-cover-page',
  orbitalName: 'BookCoverPageOrbital',
  paramFields: [
...
/** Typed guard — runtime validates StdUiBookCoverPageBookCoverPageOrbitalParams keys. */
export function isStdUiBookCoverPageBookCoverPageOrbitalParams(p: object): p is StdUiBookCoverPageBookCoverPageOrbitalParams {
  type _OverrideRecord = NonNullable<StdUiBookCoverPageBookCoverPageOrbitalParams['traitOverrides']>;
  const obj = p as { traitOverrides?: _OverrideRecord };
  if (obj.traitOverrides !== undefined) {
    if (typeof obj.traitOverrides !== "object" || obj.traitOverrides === null) return false;
    const allowed: readonly string[] = [
      ...StdUiBookCoverPageBookCoverPageOrbitalManifest.traitNames,
      ...StdUiBookCoverPageBookCoverPageOrbitalManifest.inlineTraitNames,
    ];
...
/**
 * Bundled params for ui-book-cover-page — one optional entry per orbital.
 * Each entry maps to its per-orbital factory above.
 */
export interface StdUiBookCoverPageParams {
  BookCoverPage?: StdUiBookCoverPageBookCoverPageOrbitalParams;
}

/** Whole-organism descriptor (1 orbitals). Composes per-orbital factories. */
export function stdUiBookCoverPage(params: StdUiBookCoverPageParams = {}): OrbitalDefinition[] {
  return [
    stdUiBookCoverPageBookCoverPageOrbital(params.BookCoverPage ?? {}),
  ];
}
