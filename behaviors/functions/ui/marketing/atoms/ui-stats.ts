/**
 * ui-stats — Stats — UI factory (1:1 with the @almadar/ui stats pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/ui-stats.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-stats
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/ui-stats';
const ALIAS = 'UiStats';
 ...
 */
export type StdUiStatsEventKey = 'INIT';
...
/**
 * Params for the ui-stats descriptor helpers.
 *
 ...
 */
export interface StdUiStatsParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiStatsEventKey, string>>;
  ...
  config?: StdUiStatsConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiStats.traits.StatsRender`. */
export function stdUiStatsTrait(params: StdUiStatsParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.StatsRender`,
...
/** Page descriptor: `UiStats.pages.StatsPage`. */
export function stdUiStatsPage(params: StdUiStatsParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.StatsPage`,
...
export function stdUiStats(params: StdUiStatsParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdUiStatsTrait(params),
    ],
    pages: [
      stdUiStatsPage(params),
    ],
  });
}
