/**
 * ui-pattern-tile — PatternTile — UI factory (1:1 with the @almadar/ui pattern-tile pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/ui-pattern-tile.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-pattern-tile
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/ui-pattern-tile';
const ALIAS = 'UiPatternTile';
 ...
 */
export type StdUiPatternTileEventKey = 'INIT';
...
/**
 * Params for the ui-pattern-tile descriptor helpers.
 *
 ...
 */
export interface StdUiPatternTileParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiPatternTileEventKey, string>>;
  ...
  config?: StdUiPatternTileConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiPatternTile.traits.PatternTileRender`. */
export function stdUiPatternTileTrait(params: StdUiPatternTileParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.PatternTileRender`,
...
/** Page descriptor: `UiPatternTile.pages.PatternTilePage`. */
export function stdUiPatternTilePage(params: StdUiPatternTileParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.PatternTilePage`,
...
export function stdUiPatternTile(params: StdUiPatternTileParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'PatternTileOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiPatternTileTrait(params),
    ],
    pages: [
      stdUiPatternTilePage(params),
    ],
  });
}
