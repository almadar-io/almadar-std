 ...
 * packages/almadar-std/behaviors/registry/atoms/ui-stat-card.orb.
 *
 ...
 */
export type StdUiStatCardEventKey = 'INIT';
...
/**
 * Params for the ui-stat-card descriptor helpers.
 *
...
export interface StdUiStatCardParams {
  ...
  events?: Partial<Record<StdUiStatCardEventKey, string>>;
  ...
  config?: StdUiStatCardConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiStatCard.traits.StatCardRender`. */
export function stdUiStatCardTrait(params: StdUiStatCardParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.StatCardRender`,
...
/** Page descriptor: `UiStatCard.pages.StatCardPage`. */
export function stdUiStatCardPage(params: StdUiStatCardParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.StatCardPage`,
...
export function stdUiStatCard(params: StdUiStatCardParams): OrbitalDefinition {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdUiStatCardTrait(params),
    ],
    pages: [
      stdUiStatCardPage(params),
    ],
  });
}
