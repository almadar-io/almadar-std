/**
 * ui-pull-quote — PullQuote — UI factory (1:1 with the @almadar/ui pull-quote pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/molecules/ui-pull-quote.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-pull-quote
 *
 * @level molecule
 ...
 */
export type StdUiPullQuoteEventKey = 'INIT';
...
/**
 * Params for the ui-pull-quote descriptor helpers.
 *
 ...
 */
export interface StdUiPullQuoteParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiPullQuoteEventKey, string>>;
  ...
  config?: StdUiPullQuoteConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiPullQuote.traits.PullQuoteRender`. */
export function stdUiPullQuoteTrait(params: StdUiPullQuoteParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.PullQuoteRender`,
...
/** Page descriptor: `UiPullQuote.pages.PullQuotePage`. */
export function stdUiPullQuotePage(params: StdUiPullQuoteParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.PullQuotePage`,
...
export function stdUiPullQuote(params: StdUiPullQuoteParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'PullQuoteOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiPullQuoteTrait(params),
    ],
    pages: [
      stdUiPullQuotePage(params),
    ],
  });
}
