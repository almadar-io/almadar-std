/**
 * ui-tag-cloud — TagCloud — UI factory (1:1 with the @almadar/ui tag-cloud pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/molecules/ui-tag-cloud.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-tag-cloud
 *
 * @level molecule
...
const BEHAVIOR_PATH = 'std/behaviors/ui-tag-cloud';
const ALIAS = 'UiTagCloud';
 ...
 */
export type StdUiTagCloudEventKey = 'INIT';
...
export interface StdUiTagCloudConfig {
  /** Default: `""` */
  className?: string;
  /** Default: `[{"label":"Label","href":"Href","variant":"Variant"}]` */
  tags?: EntityRow[];
  /** Default: `"default"` */
...
/**
 * Params for the ui-tag-cloud descriptor helpers.
 *
 ...
 */
export interface StdUiTagCloudParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiTagCloudEventKey, string>>;
  ...
  config?: StdUiTagCloudConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiTagCloud.traits.TagCloudRender`. */
export function stdUiTagCloudTrait(params: StdUiTagCloudParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.TagCloudRender`,
...
/** Page descriptor: `UiTagCloud.pages.TagCloudPage`. */
export function stdUiTagCloudPage(params: StdUiTagCloudParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.TagCloudPage`,
...
export function stdUiTagCloud(params: StdUiTagCloudParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'TagCloudOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiTagCloudTrait(params),
    ],
    pages: [
      stdUiTagCloudPage(params),
    ],
  });
}
