/**
 * ui-team-card — TeamCard — UI factory (1:1 with the @almadar/ui team-card pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/molecules/ui-team-card.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-team-card
 *
 * @level molecule
 ...
 */
export type StdUiTeamCardEventKey = 'INIT';
...
/**
 * Params for the ui-team-card descriptor helpers.
 *
 ...
 */
export interface StdUiTeamCardParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiTeamCardEventKey, string>>;
  ...
  config?: StdUiTeamCardConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiTeamCard.traits.TeamCardRender`. */
export function stdUiTeamCardTrait(params: StdUiTeamCardParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.TeamCardRender`,
...
/** Page descriptor: `UiTeamCard.pages.TeamCardPage`. */
export function stdUiTeamCardPage(params: StdUiTeamCardParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.TeamCardPage`,
...
export function stdUiTeamCard(params: StdUiTeamCardParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'TeamCardOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiTeamCardTrait(params),
    ],
    pages: [
      stdUiTeamCardPage(params),
    ],
  });
}
