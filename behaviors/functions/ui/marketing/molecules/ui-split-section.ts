/**
 * ui-split-section — SplitSection — UI factory (1:1 with the @almadar/ui split-section pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/molecules/ui-split-section.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-split-section
 *
 * @level molecule
 ...
 */
export type StdUiSplitSectionEventKey = 'INIT';
...
/**
 * Params for the ui-split-section descriptor helpers.
 *
 ...
 */
export interface StdUiSplitSectionParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiSplitSectionEventKey, string>>;
  ...
  config?: StdUiSplitSectionConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiSplitSection.traits.SplitSectionRender`. */
export function stdUiSplitSectionTrait(params: StdUiSplitSectionParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.SplitSectionRender`,
...
/** Page descriptor: `UiSplitSection.pages.SplitSectionPage`. */
export function stdUiSplitSectionPage(params: StdUiSplitSectionParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.SplitSectionPage`,
...
export function stdUiSplitSection(params: StdUiSplitSectionParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'SplitSectionOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiSplitSectionTrait(params),
    ],
    pages: [
      stdUiSplitSectionPage(params),
    ],
  });
}
