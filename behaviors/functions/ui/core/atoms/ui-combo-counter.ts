/**
 * ui-combo-counter — ComboCounter — UI factory (1:1 with the @almadar/ui combo-counter pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/ui-combo-counter.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-combo-counter
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/ui-combo-counter';
const ALIAS = 'UiComboCounter';
 ...
 */
export type StdUiComboCounterEventKey = 'INIT';
...
/**
 * Params for the ui-combo-counter descriptor helpers.
 *
 ...
 */
export interface StdUiComboCounterParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiComboCounterEventKey, string>>;
  ...
  config?: StdUiComboCounterConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiComboCounter.traits.ComboCounterRender`. */
export function stdUiComboCounterTrait(params: StdUiComboCounterParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.ComboCounterRender`,
...
/** Page descriptor: `UiComboCounter.pages.ComboCounterPage`. */
export function stdUiComboCounterPage(params: StdUiComboCounterParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.ComboCounterPage`,
...
export function stdUiComboCounter(params: StdUiComboCounterParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'ComboCounterOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiComboCounterTrait(params),
    ],
    pages: [
      stdUiComboCounterPage(params),
    ],
  });
}
