/**
 * ui-badge — Badge — UI factory (1:1 with the @almadar/ui badge pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/ui-badge.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-badge
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/ui-badge';
const ALIAS = 'UiBadge';
...
/**
 * Params for the ui-badge descriptor helpers.
 *
 ...
 */
export interface StdUiBadgeParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiBadgeEventKey, string>>;
  ...
  config?: StdUiBadgeConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiBadge.traits.BadgeRender`. */
export function stdUiBadgeTrait(params: StdUiBadgeParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.BadgeRender`,
...
/** Page descriptor: `UiBadge.pages.BadgePage`. */
export function stdUiBadgePage(params: StdUiBadgeParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.BadgePage`,
...
export function stdUiBadge(params: StdUiBadgeParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdUiBadgeTrait(params),
    ],
    pages: [
      stdUiBadgePage(params),
    ],
  });
}
