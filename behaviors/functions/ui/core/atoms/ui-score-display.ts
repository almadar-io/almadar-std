/**
 * ui-score-display — ScoreDisplay — UI factory (1:1 with the @almadar/ui score-display pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/ui-score-display.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-score-display
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/ui-score-display';
const ALIAS = 'UiScoreDisplay';
 ...
 */
export type StdUiScoreDisplayEventKey = 'INIT';
...
/**
 * Params for the ui-score-display descriptor helpers.
 *
 ...
 */
export interface StdUiScoreDisplayParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiScoreDisplayEventKey, string>>;
  ...
  config?: StdUiScoreDisplayConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiScoreDisplay.traits.ScoreDisplayRender`. */
export function stdUiScoreDisplayTrait(params: StdUiScoreDisplayParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.ScoreDisplayRender`,
...
/** Page descriptor: `UiScoreDisplay.pages.ScoreDisplayPage`. */
export function stdUiScoreDisplayPage(params: StdUiScoreDisplayParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.ScoreDisplayPage`,
...
export function stdUiScoreDisplay(params: StdUiScoreDisplayParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'ScoreDisplayOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiScoreDisplayTrait(params),
    ],
    pages: [
      stdUiScoreDisplayPage(params),
    ],
  });
}
