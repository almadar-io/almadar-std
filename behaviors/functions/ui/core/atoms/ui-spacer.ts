/**
 * ui-spacer — Spacer — UI factory (1:1 with the @almadar/ui spacer pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/ui-spacer.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-spacer
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/ui-spacer';
const ALIAS = 'UiSpacer';
 ...
 */
export type StdUiSpacerEventKey = 'INIT';
...
/**
 * Params for the ui-spacer descriptor helpers.
 *
 ...
 */
export interface StdUiSpacerParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiSpacerEventKey, string>>;
  ...
  config?: StdUiSpacerConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiSpacer.traits.SpacerRender`. */
export function stdUiSpacerTrait(params: StdUiSpacerParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.SpacerRender`,
...
/** Page descriptor: `UiSpacer.pages.SpacerPage`. */
export function stdUiSpacerPage(params: StdUiSpacerParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.SpacerPage`,
...
export function stdUiSpacer(params: StdUiSpacerParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdUiSpacerTrait(params),
    ],
    pages: [
      stdUiSpacerPage(params),
    ],
  });
}
