/**
 * ui-avatar — Avatar — UI factory (1:1 with the @almadar/ui avatar pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/ui-avatar.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-avatar
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/ui-avatar';
const ALIAS = 'UiAvatar';
...
/**
 * Params for the ui-avatar descriptor helpers.
 *
 ...
 */
export interface StdUiAvatarParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiAvatarEventKey, string>>;
  ...
  config?: StdUiAvatarConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiAvatar.traits.AvatarRender`. */
export function stdUiAvatarTrait(params: StdUiAvatarParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.AvatarRender`,
...
/** Page descriptor: `UiAvatar.pages.AvatarPage`. */
export function stdUiAvatarPage(params: StdUiAvatarParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.AvatarPage`,
...
export function stdUiAvatar(params: StdUiAvatarParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdUiAvatarTrait(params),
    ],
    pages: [
      stdUiAvatarPage(params),
    ],
  });
}
