/**
 * ui-xp-bar — XpBar — UI factory (1:1 with the @almadar/ui xp-bar pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/ui-xp-bar.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-xp-bar
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/ui-xp-bar';
const ALIAS = 'UiXpBar';
 ...
 */
export type StdUiXpBarEventKey = 'INIT';
...
/**
 * Params for the ui-xp-bar descriptor helpers.
 *
 ...
 */
export interface StdUiXpBarParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiXpBarEventKey, string>>;
  ...
  config?: StdUiXpBarConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiXpBar.traits.XpBarRender`. */
export function stdUiXpBarTrait(params: StdUiXpBarParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.XpBarRender`,
...
/** Page descriptor: `UiXpBar.pages.XpBarPage`. */
export function stdUiXpBarPage(params: StdUiXpBarParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.XpBarPage`,
...
export function stdUiXpBar(params: StdUiXpBarParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdUiXpBarTrait(params),
    ],
    pages: [
      stdUiXpBarPage(params),
    ],
  });
}
