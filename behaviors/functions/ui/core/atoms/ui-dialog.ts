/**
 * ui-dialog — Dialog — UI factory (1:1 with the @almadar/ui dialog pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/ui-dialog.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-dialog
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/ui-dialog';
const ALIAS = 'UiDialog';
 ...
 */
export type StdUiDialogEventKey = 'INIT';
...
/**
 * Params for the ui-dialog descriptor helpers.
 *
 ...
 */
export interface StdUiDialogParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiDialogEventKey, string>>;
  ...
  config?: StdUiDialogConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiDialog.traits.DialogRender`. */
export function stdUiDialogTrait(params: StdUiDialogParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.DialogRender`,
...
/** Page descriptor: `UiDialog.pages.DialogPage`. */
export function stdUiDialogPage(params: StdUiDialogParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.DialogPage`,
...
export function stdUiDialog(params: StdUiDialogParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdUiDialogTrait(params),
    ],
    pages: [
      stdUiDialogPage(params),
    ],
  });
}
