/**
 * ui-typography — Typography — UI factory (1:1 with the @almadar/ui typography pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/ui-typography.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-typography
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/ui-typography';
const ALIAS = 'UiTypography';
 ...
 */
export type StdUiTypographyEventKey = 'INIT';
...
/**
 * Params for the ui-typography descriptor helpers.
 *
 ...
 */
export interface StdUiTypographyParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiTypographyEventKey, string>>;
  ...
  config?: StdUiTypographyConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiTypography.traits.TypographyRender`. */
export function stdUiTypographyTrait(params: StdUiTypographyParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.TypographyRender`,
...
/** Page descriptor: `UiTypography.pages.TypographyPage`. */
export function stdUiTypographyPage(params: StdUiTypographyParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.TypographyPage`,
...
export function stdUiTypography(params: StdUiTypographyParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'TypographyOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiTypographyTrait(params),
    ],
    pages: [
      stdUiTypographyPage(params),
    ],
  });
}
