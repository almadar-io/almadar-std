/**
 * ui-checkbox — Checkbox — UI factory (1:1 with the @almadar/ui checkbox pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/ui-checkbox.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-checkbox
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/ui-checkbox';
const ALIAS = 'UiCheckbox';
...
/**
 * Params for the ui-checkbox descriptor helpers.
 *
 ...
 */
export interface StdUiCheckboxParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiCheckboxEventKey, string>>;
  ...
  config?: StdUiCheckboxConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiCheckbox.traits.CheckboxRender`. */
export function stdUiCheckboxTrait(params: StdUiCheckboxParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.CheckboxRender`,
...
/** Page descriptor: `UiCheckbox.pages.CheckboxPage`. */
export function stdUiCheckboxPage(params: StdUiCheckboxParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.CheckboxPage`,
...
export function stdUiCheckbox(params: StdUiCheckboxParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'CheckboxOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiCheckboxTrait(params),
    ],
    pages: [
      stdUiCheckboxPage(params),
    ],
  });
}
