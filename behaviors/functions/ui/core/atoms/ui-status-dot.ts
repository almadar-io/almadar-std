/**
 * ui-status-dot — StatusDot — UI factory (1:1 with the @almadar/ui status-dot pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/ui-status-dot.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-status-dot
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/ui-status-dot';
const ALIAS = 'UiStatusDot';
 ...
 */
export type StdUiStatusDotEventKey = 'INIT';
...
/**
 * Params for the ui-status-dot descriptor helpers.
 *
 ...
 */
export interface StdUiStatusDotParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiStatusDotEventKey, string>>;
  ...
  config?: StdUiStatusDotConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiStatusDot.traits.StatusDotRender`. */
export function stdUiStatusDotTrait(params: StdUiStatusDotParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.StatusDotRender`,
...
/** Page descriptor: `UiStatusDot.pages.StatusDotPage`. */
export function stdUiStatusDotPage(params: StdUiStatusDotParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.StatusDotPage`,
...
export function stdUiStatusDot(params: StdUiStatusDotParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'StatusDotOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiStatusDotTrait(params),
    ],
    pages: [
      stdUiStatusDotPage(params),
    ],
  });
}
