/**
 * ui-heading — Heading — UI factory (1:1 with the @almadar/ui heading pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/ui-heading.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-heading
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/ui-heading';
const ALIAS = 'UiHeading';
 ...
 */
export type StdUiHeadingEventKey = 'INIT';
...
/**
 * Params for the ui-heading descriptor helpers.
 *
 ...
 */
export interface StdUiHeadingParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiHeadingEventKey, string>>;
  ...
  config?: StdUiHeadingConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiHeading.traits.HeadingRender`. */
export function stdUiHeadingTrait(params: StdUiHeadingParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.HeadingRender`,
...
/** Page descriptor: `UiHeading.pages.HeadingPage`. */
export function stdUiHeadingPage(params: StdUiHeadingParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.HeadingPage`,
...
export function stdUiHeading(params: StdUiHeadingParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdUiHeadingTrait(params),
    ],
    pages: [
      stdUiHeadingPage(params),
    ],
  });
}
