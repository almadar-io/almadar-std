/**
 * ui-svg-morph — SvgMorph — UI factory (1:1 with the @almadar/ui svg-morph pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/ui-svg-morph.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-svg-morph
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/ui-svg-morph';
const ALIAS = 'UiSvgMorph';
 ...
 */
export type StdUiSvgMorphEventKey = 'INIT';
...
/**
 * Params for the ui-svg-morph descriptor helpers.
 *
 ...
 */
export interface StdUiSvgMorphParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiSvgMorphEventKey, string>>;
  ...
  config?: StdUiSvgMorphConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiSvgMorph.traits.SvgMorphRender`. */
export function stdUiSvgMorphTrait(params: StdUiSvgMorphParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.SvgMorphRender`,
...
/** Page descriptor: `UiSvgMorph.pages.SvgMorphPage`. */
export function stdUiSvgMorphPage(params: StdUiSvgMorphParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.SvgMorphPage`,
...
export function stdUiSvgMorph(params: StdUiSvgMorphParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'SvgMorphOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiSvgMorphTrait(params),
    ],
    pages: [
      stdUiSvgMorphPage(params),
    ],
  });
}
