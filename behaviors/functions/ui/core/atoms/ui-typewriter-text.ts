/**
 * ui-typewriter-text — TypewriterText — UI factory (1:1 with the @almadar/ui typewriter-text pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/ui-typewriter-text.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-typewriter-text
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/ui-typewriter-text';
const ALIAS = 'UiTypewriterText';
...
/**
 * Params for the ui-typewriter-text descriptor helpers.
 *
 ...
 */
export interface StdUiTypewriterTextParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiTypewriterTextEventKey, string>>;
  ...
  config?: StdUiTypewriterTextConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiTypewriterText.traits.TypewriterTextRender`. */
export function stdUiTypewriterTextTrait(params: StdUiTypewriterTextParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.TypewriterTextRender`,
...
/** Page descriptor: `UiTypewriterText.pages.TypewriterTextPage`. */
export function stdUiTypewriterTextPage(params: StdUiTypewriterTextParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.TypewriterTextPage`,
...
export function stdUiTypewriterText(params: StdUiTypewriterTextParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'TypewriterTextOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiTypewriterTextTrait(params),
    ],
    pages: [
      stdUiTypewriterTextPage(params),
    ],
  });
}
