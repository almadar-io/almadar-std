/**
 * ui-hstack — Hstack — UI factory (1:1 with the @almadar/ui hstack pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/ui-hstack.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-hstack
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/ui-hstack';
const ALIAS = 'UiHstack';
 ...
 */
export interface StdUiHstackParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiHstackEventKey, string>>;
...
/** Trait descriptor: `UiHstack.traits.HstackRender`. */
export function stdUiHstackTrait(params: StdUiHstackParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.HstackRender`,
...
/** Page descriptor: `UiHstack.pages.HstackPage`. */
export function stdUiHstackPage(params: StdUiHstackParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.HstackPage`,
...
export function stdUiHstack(params: StdUiHstackParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdUiHstackTrait(params),
    ],
    pages: [
      stdUiHstackPage(params),
    ],
  });
}
