/**
 * ui-control-button — ControlButton — UI factory (1:1 with the @almadar/ui control-button pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/ui-control-button.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-control-button
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/ui-control-button';
const ALIAS = 'UiControlButton';
...
/**
 * Params for the ui-control-button descriptor helpers.
 *
 ...
 */
export interface StdUiControlButtonParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiControlButtonEventKey, string>>;
  ...
  config?: StdUiControlButtonConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiControlButton.traits.ControlButtonRender`. */
export function stdUiControlButtonTrait(params: StdUiControlButtonParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.ControlButtonRender`,
...
/** Page descriptor: `UiControlButton.pages.ControlButtonPage`. */
export function stdUiControlButtonPage(params: StdUiControlButtonParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.ControlButtonPage`,
...
export function stdUiControlButton(params: StdUiControlButtonParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'ControlButtonOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiControlButtonTrait(params),
    ],
    pages: [
      stdUiControlButtonPage(params),
    ],
  });
}
