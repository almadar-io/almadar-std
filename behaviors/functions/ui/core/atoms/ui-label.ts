/**
 * ui-label — Label — UI factory (1:1 with the @almadar/ui label pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/ui-label.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-label
 *
 * @level atom
 ...
 */
export type StdUiLabelEventKey = 'INIT';
...
/**
 * Params for the ui-label descriptor helpers.
 *
 ...
 */
export interface StdUiLabelParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiLabelEventKey, string>>;
  ...
  config?: StdUiLabelConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiLabel.traits.LabelRender`. */
export function stdUiLabelTrait(params: StdUiLabelParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.LabelRender`,
...
/** Page descriptor: `UiLabel.pages.LabelPage`. */
export function stdUiLabelPage(params: StdUiLabelParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.LabelPage`,
...
export function stdUiLabel(params: StdUiLabelParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdUiLabelTrait(params),
    ],
    pages: [
      stdUiLabelPage(params),
    ],
  });
}
