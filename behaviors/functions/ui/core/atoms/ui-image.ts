/**
 * ui-image — Image — UI factory (1:1 with the @almadar/ui image pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/ui-image.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-image
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/ui-image';
const ALIAS = 'UiImage';
 ...
 */
export type StdUiImageEventKey = 'INIT';
...
/**
 * Params for the ui-image descriptor helpers.
 *
 ...
 */
export interface StdUiImageParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiImageEventKey, string>>;
  ...
  config?: StdUiImageConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiImage.traits.ImageRender`. */
export function stdUiImageTrait(params: StdUiImageParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.ImageRender`,
...
/** Page descriptor: `UiImage.pages.ImagePage`. */
export function stdUiImagePage(params: StdUiImageParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.ImagePage`,
...
export function stdUiImage(params: StdUiImageParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdUiImageTrait(params),
    ],
    pages: [
      stdUiImagePage(params),
    ],
  });
}
