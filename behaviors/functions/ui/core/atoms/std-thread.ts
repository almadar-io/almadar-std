 ...
 */
export type StdThreadEventKey = 'CANCEL_REPLY' | 'EDIT_REPLY' | 'INIT' | 'REPLY' | 'SELECT' | 'SET_THREAD_ROOT' | 'SUBMIT_REPLY' | 'ThreadPostCreateFailed' | 'ThreadPostCreated' | 'ThreadPostLoadFailed' | 'ThreadPostLoaded';
...
export interface StdThreadConfig {
  /** Default: `{"children":[["if",["!=","@config.sectionTitle",""],{"content":"@config.sectionTitle","type":"typography","variant":"h4"},{"children":[],"gap":"none","type":"stack"}],{"entity":"@payload.data","fields":[{"label":"Author","name":"authorName","variant":"h4"},{"label":"","name":"content","variant":"body"},{"label":"Votes","name":"voteCount","variant":"caption"}],"gap":"sm","itemActions":[{"event":"REPLY","icon":"message-square","label":"Reply"}],"look":"@config.tableLook","type":"data-list","variant":"card"},["if",["!=","@config.sectionTitle",""],{"action":"REPLY","icon":"message-square","label":"@config.composerLabel","type":"button","variant":"secondary"},{"children":[],"gap":"none","type":"stack"}]],"direction":"vertical","gap":"md","type":"stack"}` */
  bodyContent?: unknown;
  /** Default: `"Add comment"` */
