/**
 * ui-text-highlight — TextHighlight — UI factory (1:1 with the @almadar/ui text-highlight pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/ui-text-highlight.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-text-highlight
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/ui-text-highlight';
const ALIAS = 'UiTextHighlight';
...
/**
 * Params for the ui-text-highlight descriptor helpers.
 *
 ...
 */
export interface StdUiTextHighlightParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiTextHighlightEventKey, string>>;
  ...
  config?: StdUiTextHighlightConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiTextHighlight.traits.TextHighlightRender`. */
export function stdUiTextHighlightTrait(params: StdUiTextHighlightParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.TextHighlightRender`,
...
/** Page descriptor: `UiTextHighlight.pages.TextHighlightPage`. */
export function stdUiTextHighlightPage(params: StdUiTextHighlightParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.TextHighlightPage`,
...
export function stdUiTextHighlight(params: StdUiTextHighlightParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'TextHighlightOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiTextHighlightTrait(params),
    ],
    pages: [
      stdUiTextHighlightPage(params),
    ],
  });
}
