/**
 * ui-section-header — SectionHeader — UI factory (1:1 with the @almadar/ui section-header pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/ui-section-header.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-section-header
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/ui-section-header';
const ALIAS = 'UiSectionHeader';
 ...
 */
export type StdUiSectionHeaderEventKey = 'INIT';
...
/**
 * Params for the ui-section-header descriptor helpers.
 *
 ...
 */
export interface StdUiSectionHeaderParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiSectionHeaderEventKey, string>>;
  ...
  config?: StdUiSectionHeaderConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiSectionHeader.traits.SectionHeaderRender`. */
export function stdUiSectionHeaderTrait(params: StdUiSectionHeaderParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.SectionHeaderRender`,
...
/** Page descriptor: `UiSectionHeader.pages.SectionHeaderPage`. */
export function stdUiSectionHeaderPage(params: StdUiSectionHeaderParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.SectionHeaderPage`,
...
export function stdUiSectionHeader(params: StdUiSectionHeaderParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'SectionHeaderOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiSectionHeaderTrait(params),
    ],
    pages: [
      stdUiSectionHeaderPage(params),
    ],
  });
}
