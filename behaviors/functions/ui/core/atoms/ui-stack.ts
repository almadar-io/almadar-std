/**
 * ui-stack — Stack — UI factory (1:1 with the @almadar/ui stack pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/ui-stack.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-stack
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/ui-stack';
const ALIAS = 'UiStack';
 ...
 */
export interface StdUiStackActionPayload {
  id?: string;
}
...
/**
 * Params for the ui-stack descriptor helpers.
 *
 ...
 */
export interface StdUiStackParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiStackEventKey, string>>;
  ...
  config?: StdUiStackConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiStack.traits.StackRender`. */
export function stdUiStackTrait(params: StdUiStackParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.StackRender`,
...
/** Page descriptor: `UiStack.pages.StackPage`. */
export function stdUiStackPage(params: StdUiStackParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.StackPage`,
...
export function stdUiStack(params: StdUiStackParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdUiStackTrait(params),
    ],
    pages: [
      stdUiStackPage(params),
    ],
  });
}
