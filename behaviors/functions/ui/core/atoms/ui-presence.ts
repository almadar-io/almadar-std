/**
 * ui-presence — Presence — UI factory (1:1 with the @almadar/ui presence pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/ui-presence.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-presence
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/ui-presence';
const ALIAS = 'UiPresence';
...
/**
 * Params for the ui-presence descriptor helpers.
 *
 ...
 */
export interface StdUiPresenceParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiPresenceEventKey, string>>;
  ...
  config?: StdUiPresenceConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiPresence.traits.PresenceRender`. */
export function stdUiPresenceTrait(params: StdUiPresenceParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.PresenceRender`,
...
/** Page descriptor: `UiPresence.pages.PresencePage`. */
export function stdUiPresencePage(params: StdUiPresenceParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.PresencePage`,
...
export function stdUiPresence(params: StdUiPresenceParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'PresenceOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiPresenceTrait(params),
    ],
    pages: [
      stdUiPresencePage(params),
    ],
  });
}
