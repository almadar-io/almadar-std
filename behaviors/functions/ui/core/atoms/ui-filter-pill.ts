/**
 * ui-filter-pill — FilterPill — UI factory (1:1 with the @almadar/ui filter-pill pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/ui-filter-pill.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-filter-pill
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/ui-filter-pill';
const ALIAS = 'UiFilterPill';
 ...
 */
export interface StdUiFilterPillClickPayload {
  label: string;
}
...
/**
 * Params for the ui-filter-pill descriptor helpers.
 *
 ...
 */
export interface StdUiFilterPillParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiFilterPillEventKey, string>>;
  ...
  config?: StdUiFilterPillConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiFilterPill.traits.FilterPillRender`. */
export function stdUiFilterPillTrait(params: StdUiFilterPillParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.FilterPillRender`,
...
/** Page descriptor: `UiFilterPill.pages.FilterPillPage`. */
export function stdUiFilterPillPage(params: StdUiFilterPillParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.FilterPillPage`,
...
export function stdUiFilterPill(params: StdUiFilterPillParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'FilterPillOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiFilterPillTrait(params),
    ],
    pages: [
      stdUiFilterPillPage(params),
    ],
  });
}
