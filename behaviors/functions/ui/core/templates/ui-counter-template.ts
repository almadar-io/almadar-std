/**
 * ui-counter-template — CounterTemplate — UI factory (1:1 with the @almadar/ui counter-template pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/templates/ui-counter-template.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-counter-template
 *
 * @level template
...
const BEHAVIOR_PATH = 'std/behaviors/ui-counter-template';
const ALIAS = 'UiCounterTemplate';
...
/**
 * Params for the ui-counter-template descriptor helpers.
 *
 ...
 */
export interface StdUiCounterTemplateParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiCounterTemplateEventKey, string>>;
  ...
  config?: StdUiCounterTemplateConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiCounterTemplate.traits.CounterTemplateRender`. */
export function stdUiCounterTemplateTrait(params: StdUiCounterTemplateParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.CounterTemplateRender`,
...
/** Page descriptor: `UiCounterTemplate.pages.CounterTemplatePage`. */
export function stdUiCounterTemplatePage(params: StdUiCounterTemplateParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.CounterTemplatePage`,
...
export function stdUiCounterTemplate(params: StdUiCounterTemplateParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'CounterTemplateOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiCounterTemplateTrait(params),
    ],
    pages: [
      stdUiCounterTemplatePage(params),
    ],
  });
}
