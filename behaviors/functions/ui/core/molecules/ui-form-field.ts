/**
 * ui-form-field — FormField — UI factory (1:1 with the @almadar/ui form-field pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/molecules/ui-form-field.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-form-field
 *
 * @level molecule
 ...
 */
export type StdUiFormFieldEventKey = 'INIT';
...
/**
 * Params for the ui-form-field descriptor helpers.
 *
 ...
 */
export interface StdUiFormFieldParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiFormFieldEventKey, string>>;
  ...
  config?: StdUiFormFieldConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiFormField.traits.FormFieldRender`. */
export function stdUiFormFieldTrait(params: StdUiFormFieldParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.FormFieldRender`,
...
/** Page descriptor: `UiFormField.pages.FormFieldPage`. */
export function stdUiFormFieldPage(params: StdUiFormFieldParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.FormFieldPage`,
...
export function stdUiFormField(params: StdUiFormFieldParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdUiFormFieldTrait(params),
    ],
    pages: [
      stdUiFormFieldPage(params),
    ],
  });
}
