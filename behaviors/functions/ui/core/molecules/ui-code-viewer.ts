 ...
 * packages/almadar-std/behaviors/registry/molecules/ui-code-viewer.orb.
 *
...
/**
 * Params for the ui-code-viewer descriptor helpers.
 *
...
export interface StdUiCodeViewerParams {
  ...
  events?: Partial<Record<StdUiCodeViewerEventKey, string>>;
  ...
  config?: StdUiCodeViewerConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiCodeViewer.traits.CodeViewerRender`. */
export function stdUiCodeViewerTrait(params: StdUiCodeViewerParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.CodeViewerRender`,
...
/** Page descriptor: `UiCodeViewer.pages.CodeViewerPage`. */
export function stdUiCodeViewerPage(params: StdUiCodeViewerParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.CodeViewerPage`,
...
export function stdUiCodeViewer(params: StdUiCodeViewerParams): OrbitalDefinition {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdUiCodeViewerTrait(params),
    ],
    pages: [
      stdUiCodeViewerPage(params),
    ],
  });
}
