/**
 * ui-container — Container — UI factory (1:1 with the @almadar/ui container pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/molecules/ui-container.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-container
 *
 * @level molecule
...
const BEHAVIOR_PATH = 'std/behaviors/ui-container';
const ALIAS = 'UiContainer';
 ...
 */
export type StdUiContainerEventKey = 'INIT';
...
/**
 * Params for the ui-container descriptor helpers.
 *
 ...
 */
export interface StdUiContainerParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiContainerEventKey, string>>;
  ...
  config?: StdUiContainerConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiContainer.traits.ContainerRender`. */
export function stdUiContainerTrait(params: StdUiContainerParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.ContainerRender`,
...
/** Page descriptor: `UiContainer.pages.ContainerPage`. */
export function stdUiContainerPage(params: StdUiContainerParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.ContainerPage`,
...
export function stdUiContainer(params: StdUiContainerParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'ContainerOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiContainerTrait(params),
    ],
    pages: [
      stdUiContainerPage(params),
    ],
  });
}
