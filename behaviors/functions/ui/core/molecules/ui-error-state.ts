/**
 * ui-error-state — ErrorState — UI factory (1:1 with the @almadar/ui error-state pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/molecules/ui-error-state.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-error-state
 *
 * @level molecule
...
const BEHAVIOR_PATH = 'std/behaviors/ui-error-state';
const ALIAS = 'UiErrorState';
...
/**
 * Params for the ui-error-state descriptor helpers.
 *
 ...
 */
export interface StdUiErrorStateParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiErrorStateEventKey, string>>;
  ...
  config?: StdUiErrorStateConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiErrorState.traits.ErrorStateRender`. */
export function stdUiErrorStateTrait(params: StdUiErrorStateParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.ErrorStateRender`,
...
/** Page descriptor: `UiErrorState.pages.ErrorStatePage`. */
export function stdUiErrorStatePage(params: StdUiErrorStateParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.ErrorStatePage`,
...
export function stdUiErrorState(params: StdUiErrorStateParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'ErrorStateOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiErrorStateTrait(params),
    ],
    pages: [
      stdUiErrorStatePage(params),
    ],
  });
}
