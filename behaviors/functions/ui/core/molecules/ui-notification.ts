/**
 * ui-notification — Notification — UI factory (1:1 with the @almadar/ui notification pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/molecules/ui-notification.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-notification
 *
 * @level molecule
 ...
 */
export type StdUiNotificationEventKey = 'ACTION' | 'DISMISS' | 'INIT';

/**
 * Payload shape for the `DISMISS` event.
 */
export interface StdUiNotificationDismissPayload {
  id?: string;
}
 ...
 */
export interface StdUiNotificationActionPayload {
  id?: string;
}
...
/**
 * Params for the ui-notification descriptor helpers.
 *
 ...
 */
export interface StdUiNotificationParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiNotificationEventKey, string>>;
  ...
  config?: StdUiNotificationConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiNotification.traits.NotificationRender`. */
export function stdUiNotificationTrait(params: StdUiNotificationParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.NotificationRender`,
...
/** Page descriptor: `UiNotification.pages.NotificationPage`. */
export function stdUiNotificationPage(params: StdUiNotificationParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.NotificationPage`,
...
export function stdUiNotification(params: StdUiNotificationParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdUiNotificationTrait(params),
    ],
    pages: [
      stdUiNotificationPage(params),
    ],
  });
}
