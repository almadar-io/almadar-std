/**
 * ui-side-panel — SidePanel — UI factory (1:1 with the @almadar/ui side-panel pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/molecules/ui-side-panel.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-side-panel
 *
 * @level molecule
...
const BEHAVIOR_PATH = 'std/behaviors/ui-side-panel';
const ALIAS = 'UiSidePanel';
...
/**
 * Params for the ui-side-panel descriptor helpers.
 *
 ...
 */
export interface StdUiSidePanelParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiSidePanelEventKey, string>>;
  ...
  config?: StdUiSidePanelConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiSidePanel.traits.SidePanelRender`. */
export function stdUiSidePanelTrait(params: StdUiSidePanelParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.SidePanelRender`,
...
/** Page descriptor: `UiSidePanel.pages.SidePanelPage`. */
export function stdUiSidePanelPage(params: StdUiSidePanelParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.SidePanelPage`,
...
export function stdUiSidePanel(params: StdUiSidePanelParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'SidePanelOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiSidePanelTrait(params),
    ],
    pages: [
      stdUiSidePanelPage(params),
    ],
  });
}
