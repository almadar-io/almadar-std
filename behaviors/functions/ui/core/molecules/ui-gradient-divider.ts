 ...
 * packages/almadar-std/behaviors/registry/molecules/ui-gradient-divider.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-gradient-divider
 *
 * @level molecule
...
const BEHAVIOR_PATH = 'std/behaviors/ui-gradient-divider';
const ALIAS = 'UiGradientDivider';
 ...
 */
export type StdUiGradientDividerEventKey = 'INIT';
...
/**
 * Params for the ui-gradient-divider descriptor helpers.
 *
 ...
 */
export interface StdUiGradientDividerParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiGradientDividerEventKey, string>>;
  ...
  config?: StdUiGradientDividerConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiGradientDivider.traits.GradientDividerRender`. */
export function stdUiGradientDividerTrait(params: StdUiGradientDividerParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.GradientDividerRender`,
...
/** Page descriptor: `UiGradientDivider.pages.GradientDividerPage`. */
export function stdUiGradientDividerPage(params: StdUiGradientDividerParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.GradientDividerPage`,
...
export function stdUiGradientDivider(params: StdUiGradientDividerParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'GradientDividerOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiGradientDividerTrait(params),
    ],
    pages: [
      stdUiGradientDividerPage(params),
    ],
  });
}
