/**
 * ui-swipeable-row — SwipeableRow — UI factory (1:1 with the @almadar/ui swipeable-row pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/molecules/ui-swipeable-row.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-swipeable-row
 *
 * @level molecule
...
const BEHAVIOR_PATH = 'std/behaviors/ui-swipeable-row';
const ALIAS = 'UiSwipeableRow';
...
/**
 * Params for the ui-swipeable-row descriptor helpers.
 *
 ...
 */
export interface StdUiSwipeableRowParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiSwipeableRowEventKey, string>>;
  ...
  config?: StdUiSwipeableRowConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiSwipeableRow.traits.SwipeableRowRender`. */
export function stdUiSwipeableRowTrait(params: StdUiSwipeableRowParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.SwipeableRowRender`,
...
/** Page descriptor: `UiSwipeableRow.pages.SwipeableRowPage`. */
export function stdUiSwipeableRowPage(params: StdUiSwipeableRowParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.SwipeableRowPage`,
...
export function stdUiSwipeableRow(params: StdUiSwipeableRowParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'SwipeableRowOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiSwipeableRowTrait(params),
    ],
    pages: [
      stdUiSwipeableRowPage(params),
    ],
  });
}
