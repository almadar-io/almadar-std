 ...
 * packages/almadar-std/behaviors/registry/molecules/ui-section.orb.
 *
...
/**
 * Params for the ui-section descriptor helpers.
 *
...
export interface StdUiSectionParams {
  ...
  events?: Partial<Record<StdUiSectionEventKey, string>>;
  ...
  config?: StdUiSectionConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiSection.traits.SectionRender`. */
export function stdUiSectionTrait(params: StdUiSectionParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.SectionRender`,
...
/** Page descriptor: `UiSection.pages.SectionPage`. */
export function stdUiSectionPage(params: StdUiSectionParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.SectionPage`,
...
export function stdUiSection(params: StdUiSectionParams): OrbitalDefinition {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdUiSectionTrait(params),
    ],
    pages: [
      stdUiSectionPage(params),
    ],
  });
}
