...
export interface StdUiViolationAlertConfig {
  /** Default: `{"article":"Article","penaltyAction":"Penalty Action","law":"Law","actionType":"measure","adminAction":"Admin Action","fieldId":"Field Id","id":"Id","tabId":"Tab Id","message":"Message"}` */
  violation?: EntityRow;
  /** Default: `"warning"` */
