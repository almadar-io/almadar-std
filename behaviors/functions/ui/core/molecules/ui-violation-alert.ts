...
export interface StdUiViolationAlertConfig {
  ...
  /** Default: `""` */
  className?: string;
  /** Default: `{"fieldId":"Field Id","penaltyAction":"Penalty Action","tabId":"Tab Id","actionType":"measure","message":"Message","id":"Id","adminAction":"Admin Action","article":"Article","law":"Law"}` */
  violation?: EntityRow;
}
