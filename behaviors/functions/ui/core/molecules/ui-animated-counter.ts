/**
 * ui-animated-counter — AnimatedCounter — UI factory (1:1 with the @almadar/ui animated-counter pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/molecules/ui-animated-counter.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-animated-counter
 *
 * @level molecule
 ...
 */
export type StdUiAnimatedCounterEventKey = 'INIT';
 ...
 */
export interface StdUiAnimatedCounterParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiAnimatedCounterEventKey, string>>;
  ...
  config?: StdUiAnimatedCounterConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiAnimatedCounter.traits.AnimatedCounterRender`. */
export function stdUiAnimatedCounterTrait(params: StdUiAnimatedCounterParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.AnimatedCounterRender`,
...
/** Page descriptor: `UiAnimatedCounter.pages.AnimatedCounterPage`. */
export function stdUiAnimatedCounterPage(params: StdUiAnimatedCounterParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.AnimatedCounterPage`,
...
export function stdUiAnimatedCounter(params: StdUiAnimatedCounterParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'AnimatedCounterOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiAnimatedCounterTrait(params),
    ],
    pages: [
      stdUiAnimatedCounterPage(params),
    ],
  });
}
