/**
 * ui-progress-dots — ProgressDots — UI factory (1:1 with the @almadar/ui progress-dots pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/molecules/ui-progress-dots.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-progress-dots
 *
 * @level molecule
...
const BEHAVIOR_PATH = 'std/behaviors/ui-progress-dots';
const ALIAS = 'UiProgressDots';
 ...
 */
export interface StdUiProgressDotsDotClickPayload {
  index?: number;
}
...
/**
 * Params for the ui-progress-dots descriptor helpers.
 *
 ...
 */
export interface StdUiProgressDotsParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiProgressDotsEventKey, string>>;
  ...
  config?: StdUiProgressDotsConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiProgressDots.traits.ProgressDotsRender`. */
export function stdUiProgressDotsTrait(params: StdUiProgressDotsParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.ProgressDotsRender`,
...
/** Page descriptor: `UiProgressDots.pages.ProgressDotsPage`. */
export function stdUiProgressDotsPage(params: StdUiProgressDotsParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.ProgressDotsPage`,
...
export function stdUiProgressDots(params: StdUiProgressDotsParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'ProgressDotsOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiProgressDotsTrait(params),
    ],
    pages: [
      stdUiProgressDotsPage(params),
    ],
  });
}
