/**
 * ui-line-chart — LineChart — UI factory (1:1 with the @almadar/ui line-chart pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/molecules/ui-line-chart.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-line-chart
 *
 * @level molecule
...
const BEHAVIOR_PATH = 'std/behaviors/ui-line-chart';
const ALIAS = 'UiLineChart';
 ...
 */
export type StdUiLineChartEventKey = 'INIT';
...
/**
 * Params for the ui-line-chart descriptor helpers.
 *
 ...
 */
export interface StdUiLineChartParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiLineChartEventKey, string>>;
  ...
  config?: StdUiLineChartConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiLineChart.traits.LineChartRender`. */
export function stdUiLineChartTrait(params: StdUiLineChartParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.LineChartRender`,
...
/** Page descriptor: `UiLineChart.pages.LineChartPage`. */
export function stdUiLineChartPage(params: StdUiLineChartParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.LineChartPage`,
...
export function stdUiLineChart(params: StdUiLineChartParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'LineChartOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiLineChartTrait(params),
    ],
    pages: [
      stdUiLineChartPage(params),
    ],
  });
}
