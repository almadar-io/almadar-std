 ...
 */
export type StdUiGraphCanvasEventKey = 'BADGE_CLICK' | 'INIT' | 'MARK_CLICK' | 'NODE_CLICK' | 'NODE_DOUBLE_CLICK';
...
/**
 * Payload shape for the `MARK_CLICK` event.
 */
export interface StdUiGraphCanvasMarkClickPayload {
  node?: EntityRow;
}
...
/**
 * Payload shape for the `BADGE_CLICK` event.
 */
export interface StdUiGraphCanvasBadgeClickPayload {
  node?: EntityRow;
}
