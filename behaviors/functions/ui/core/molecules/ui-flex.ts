/**
 * ui-flex — Flex — UI factory (1:1 with the @almadar/ui flex pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/molecules/ui-flex.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-flex
 *
 * @level molecule
...
const BEHAVIOR_PATH = 'std/behaviors/ui-flex';
const ALIAS = 'UiFlex';
 ...
 */
export type StdUiFlexEventKey = 'INIT';
...
/**
 * Params for the ui-flex descriptor helpers.
 *
 ...
 */
export interface StdUiFlexParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiFlexEventKey, string>>;
  ...
  config?: StdUiFlexConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiFlex.traits.FlexRender`. */
export function stdUiFlexTrait(params: StdUiFlexParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.FlexRender`,
...
/** Page descriptor: `UiFlex.pages.FlexPage`. */
export function stdUiFlexPage(params: StdUiFlexParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.FlexPage`,
...
export function stdUiFlex(params: StdUiFlexParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdUiFlexTrait(params),
    ],
    pages: [
      stdUiFlexPage(params),
    ],
  });
}
