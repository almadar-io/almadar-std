/**
 * ui-chart-legend — ChartLegend — UI factory (1:1 with the @almadar/ui chart-legend pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/molecules/ui-chart-legend.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-chart-legend
 *
 * @level molecule
...
const BEHAVIOR_PATH = 'std/behaviors/ui-chart-legend';
const ALIAS = 'UiChartLegend';
 ...
 */
export type StdUiChartLegendEventKey = 'INIT';
...
/**
 * Params for the ui-chart-legend descriptor helpers.
 *
 ...
 */
export interface StdUiChartLegendParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiChartLegendEventKey, string>>;
  ...
  config?: StdUiChartLegendConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiChartLegend.traits.ChartLegendRender`. */
export function stdUiChartLegendTrait(params: StdUiChartLegendParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.ChartLegendRender`,
...
/** Page descriptor: `UiChartLegend.pages.ChartLegendPage`. */
export function stdUiChartLegendPage(params: StdUiChartLegendParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.ChartLegendPage`,
...
export function stdUiChartLegend(params: StdUiChartLegendParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'ChartLegendOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiChartLegendTrait(params),
    ],
    pages: [
      stdUiChartLegendPage(params),
    ],
  });
}
