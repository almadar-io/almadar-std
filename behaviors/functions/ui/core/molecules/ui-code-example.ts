/**
 * ui-code-example — CodeExample — UI factory (1:1 with the @almadar/ui code-example pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/molecules/ui-code-example.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-code-example
 *
 * @level molecule
...
const BEHAVIOR_PATH = 'std/behaviors/ui-code-example';
const ALIAS = 'UiCodeExample';
 ...
 */
export type StdUiCodeExampleEventKey = 'INIT';
...
/**
 * Params for the ui-code-example descriptor helpers.
 *
 ...
 */
export interface StdUiCodeExampleParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiCodeExampleEventKey, string>>;
  ...
  config?: StdUiCodeExampleConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiCodeExample.traits.CodeExampleRender`. */
export function stdUiCodeExampleTrait(params: StdUiCodeExampleParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.CodeExampleRender`,
...
/** Page descriptor: `UiCodeExample.pages.CodeExamplePage`. */
export function stdUiCodeExamplePage(params: StdUiCodeExampleParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.CodeExamplePage`,
...
export function stdUiCodeExample(params: StdUiCodeExampleParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'CodeExampleOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiCodeExampleTrait(params),
    ],
    pages: [
      stdUiCodeExamplePage(params),
    ],
  });
}
