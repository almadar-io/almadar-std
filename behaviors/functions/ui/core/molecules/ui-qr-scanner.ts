/**
 * ui-qr-scanner — QrScanner — UI factory (1:1 with the @almadar/ui qr-scanner pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/molecules/ui-qr-scanner.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-qr-scanner
 *
 * @level molecule
...
/**
 * Params for the ui-qr-scanner descriptor helpers.
 *
 ...
 */
export interface StdUiQrScannerParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiQrScannerEventKey, string>>;
  ...
  config?: StdUiQrScannerConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiQrScanner.traits.QrScannerRender`. */
export function stdUiQrScannerTrait(params: StdUiQrScannerParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.QrScannerRender`,
...
/** Page descriptor: `UiQrScanner.pages.QrScannerPage`. */
export function stdUiQrScannerPage(params: StdUiQrScannerParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.QrScannerPage`,
...
export function stdUiQrScanner(params: StdUiQrScannerParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'QrScannerOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiQrScannerTrait(params),
    ],
    pages: [
      stdUiQrScannerPage(params),
    ],
  });
}
