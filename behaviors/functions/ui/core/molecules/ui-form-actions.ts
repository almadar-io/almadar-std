/**
 * ui-form-actions — FormActions — UI factory (1:1 with the @almadar/ui form-actions pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/molecules/ui-form-actions.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-form-actions
 *
 * @level molecule
...
const BEHAVIOR_PATH = 'std/behaviors/ui-form-actions';
const ALIAS = 'UiFormActions';
 ...
 */
export type StdUiFormActionsEventKey = 'INIT';
...
export interface StdUiFormActionsConfig {
  /** Default: `{"label":"Label","actionType":"Action Type","navigatesTo":"Navigates To","variant":"Variant"}` */
  primary?: EntityRow;
  ...
  /** Default: `""` */
  className?: string;
  /** Default: `[{"label":"Label","actionType":"Action Type","variant":"Variant","navigatesTo":"Navigates To"}]` */
  secondary?: EntityRow[];
  /** Default: `"default"` */
  variant?: 'default' | 'segmented' | 'toggle';
  /** Default: `[{"type":"checkbox","label":"Label","field":"Field","options":["Item"]}]` */
  filters?: EntityRow[];
}

/**
 * Params for the ui-form-actions descriptor helpers.
 *
 ...
 */
export interface StdUiFormActionsParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiFormActionsEventKey, string>>;
  ...
  config?: StdUiFormActionsConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiFormActions.traits.FormActionsRender`. */
export function stdUiFormActionsTrait(params: StdUiFormActionsParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.FormActionsRender`,
...
/** Page descriptor: `UiFormActions.pages.FormActionsPage`. */
export function stdUiFormActionsPage(params: StdUiFormActionsParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.FormActionsPage`,
...
export function stdUiFormActions(params: StdUiFormActionsParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdUiFormActionsTrait(params),
    ],
    pages: [
      stdUiFormActionsPage(params),
    ],
  });
}
