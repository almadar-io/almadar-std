/**
 * ui-doc-sidebar — DocSidebar — UI factory (1:1 with the @almadar/ui doc-sidebar pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/molecules/ui-doc-sidebar.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-doc-sidebar
 *
 * @level molecule
...
const BEHAVIOR_PATH = 'std/behaviors/ui-doc-sidebar';
const ALIAS = 'UiDocSidebar';
 ...
 */
export type StdUiDocSidebarEventKey = 'INIT';
...
export interface StdUiDocSidebarConfig {
  /** Default: `[{"href":"Href","label":"Label","items":[],"active":false}]` */
  items?: EntityRow[];
  /** Default: `""` */
  className?: string;
}
...
/**
 * Params for the ui-doc-sidebar descriptor helpers.
 *
 ...
 */
export interface StdUiDocSidebarParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiDocSidebarEventKey, string>>;
  ...
  config?: StdUiDocSidebarConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiDocSidebar.traits.DocSidebarRender`. */
export function stdUiDocSidebarTrait(params: StdUiDocSidebarParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.DocSidebarRender`,
...
/** Page descriptor: `UiDocSidebar.pages.DocSidebarPage`. */
export function stdUiDocSidebarPage(params: StdUiDocSidebarParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.DocSidebarPage`,
...
export function stdUiDocSidebar(params: StdUiDocSidebarParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'DocSidebarOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiDocSidebarTrait(params),
    ],
    pages: [
      stdUiDocSidebarPage(params),
    ],
  });
}
