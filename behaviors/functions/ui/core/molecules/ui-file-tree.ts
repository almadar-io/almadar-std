/**
 * ui-file-tree — FileTree — UI factory (1:1 with the @almadar/ui file-tree pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/molecules/ui-file-tree.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-file-tree
 *
 * @level molecule
...
const BEHAVIOR_PATH = 'std/behaviors/ui-file-tree';
const ALIAS = 'UiFileTree';
 ...
 */
export type StdUiFileTreeEventKey = 'FILE_SELECT' | 'INIT';

/**
 * Payload shape for the `FILE_SELECT` event.
 */
export interface StdUiFileTreeFileSelectPayload {
  path?: string;
}
...
export interface StdUiFileTreeConfig {
  /** Default: `[{"type":"file","children":[],"size":1,"language":"Language","name":"Name","path":"Path"}]` */
  tree?: EntityRow[];
  /** Default: `""` */
  className?: string;
...
/**
 * Params for the ui-file-tree descriptor helpers.
 *
 ...
 */
export interface StdUiFileTreeParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiFileTreeEventKey, string>>;
  ...
  config?: StdUiFileTreeConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiFileTree.traits.FileTreeRender`. */
export function stdUiFileTreeTrait(params: StdUiFileTreeParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.FileTreeRender`,
...
/** Page descriptor: `UiFileTree.pages.FileTreePage`. */
export function stdUiFileTreePage(params: StdUiFileTreeParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.FileTreePage`,
...
export function stdUiFileTree(params: StdUiFileTreeParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdUiFileTreeTrait(params),
    ],
    pages: [
      stdUiFileTreePage(params),
    ],
  });
}
