/**
 * ui-breadcrumb — Breadcrumb — UI factory (1:1 with the @almadar/ui breadcrumb pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/molecules/ui-breadcrumb.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-breadcrumb
 *
 * @level molecule
...
const BEHAVIOR_PATH = 'std/behaviors/ui-breadcrumb';
const ALIAS = 'UiBreadcrumb';
 ...
 */
export type StdUiBreadcrumbEventKey = 'INIT';
...
export interface StdUiBreadcrumbConfig {
  /** Default: `[{"isCurrent":false,"label":"Label","href":"Href","icon":"circle","path":"Path"}]` */
  items?: EntityRow[];
  /** Default: `""` */
  className?: string;
  separator?: unknown;
...
/**
 * Params for the ui-breadcrumb descriptor helpers.
 *
 ...
 */
export interface StdUiBreadcrumbParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiBreadcrumbEventKey, string>>;
  ...
  config?: StdUiBreadcrumbConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiBreadcrumb.traits.BreadcrumbRender`. */
export function stdUiBreadcrumbTrait(params: StdUiBreadcrumbParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.BreadcrumbRender`,
...
/** Page descriptor: `UiBreadcrumb.pages.BreadcrumbPage`. */
export function stdUiBreadcrumbPage(params: StdUiBreadcrumbParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.BreadcrumbPage`,
...
export function stdUiBreadcrumb(params: StdUiBreadcrumbParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'BreadcrumbOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiBreadcrumbTrait(params),
    ],
    pages: [
      stdUiBreadcrumbPage(params),
    ],
  });
}
