/**
 * ui-drawer — Drawer — UI factory (1:1 with the @almadar/ui drawer pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/molecules/ui-drawer.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-drawer
 *
 * @level molecule
...
const BEHAVIOR_PATH = 'std/behaviors/ui-drawer';
const ALIAS = 'UiDrawer';
...
/**
 * Params for the ui-drawer descriptor helpers.
 *
 ...
 */
export interface StdUiDrawerParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiDrawerEventKey, string>>;
  ...
  config?: StdUiDrawerConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiDrawer.traits.DrawerRender`. */
export function stdUiDrawerTrait(params: StdUiDrawerParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.DrawerRender`,
...
/** Page descriptor: `UiDrawer.pages.DrawerPage`. */
export function stdUiDrawerPage(params: StdUiDrawerParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.DrawerPage`,
...
export function stdUiDrawer(params: StdUiDrawerParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdUiDrawerTrait(params),
    ],
    pages: [
      stdUiDrawerPage(params),
    ],
  });
}
