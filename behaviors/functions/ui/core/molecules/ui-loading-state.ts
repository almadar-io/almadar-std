/**
 * ui-loading-state — LoadingState — UI factory (1:1 with the @almadar/ui loading-state pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/molecules/ui-loading-state.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-loading-state
 *
 * @level molecule
...
const BEHAVIOR_PATH = 'std/behaviors/ui-loading-state';
const ALIAS = 'UiLoadingState';
 ...
 */
export type StdUiLoadingStateEventKey = 'INIT';
...
/**
 * Params for the ui-loading-state descriptor helpers.
 *
 ...
 */
export interface StdUiLoadingStateParams {
  entityName: string;
  ...
  events?: Partial<Record<StdUiLoadingStateEventKey, string>>;
  ...
  config?: StdUiLoadingStateConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `UiLoadingState.traits.LoadingStateRender`. */
export function stdUiLoadingStateTrait(params: StdUiLoadingStateParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.LoadingStateRender`,
...
/** Page descriptor: `UiLoadingState.pages.LoadingStatePage`. */
export function stdUiLoadingStatePage(params: StdUiLoadingStateParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.LoadingStatePage`,
...
export function stdUiLoadingState(params: StdUiLoadingStateParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'LoadingStateOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdUiLoadingStateTrait(params),
    ],
    pages: [
      stdUiLoadingStatePage(params),
    ],
  });
}
