/**
 * ui-code-runner-panel — CodeRunnerPanel — UI factory (1:1 with the @almadar/ui code-runner-panel pattern).
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/organisms/ui-code-runner-panel.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=ui-code-runner-panel
 *
 * @level organism
 ...
 *
 * Canonical entity: CodeRunnerPanelItem — overridable via
 ...
 */
export interface StdUiCodeRunnerPanelCodeRunnerPanelOrbitalParams {
...
/** Manifest — describes the params surface of stdUiCodeRunnerPanelCodeRunnerPanelOrbital. */
export const StdUiCodeRunnerPanelCodeRunnerPanelOrbitalManifest = {
  organism: 'ui-code-runner-panel',
  orbitalName: 'CodeRunnerPanelOrbital',
  paramFields: [
...
/** Typed guard — runtime validates StdUiCodeRunnerPanelCodeRunnerPanelOrbitalParams keys. */
export function isStdUiCodeRunnerPanelCodeRunnerPanelOrbitalParams(p: object): p is StdUiCodeRunnerPanelCodeRunnerPanelOrbitalParams {
  type _OverrideRecord = NonNullable<StdUiCodeRunnerPanelCodeRunnerPanelOrbitalParams['traitOverrides']>;
  const obj = p as { traitOverrides?: _OverrideRecord };
  if (obj.traitOverrides !== undefined) {
    if (typeof obj.traitOverrides !== "object" || obj.traitOverrides === null) return false;
    const allowed: readonly string[] = [
      ...StdUiCodeRunnerPanelCodeRunnerPanelOrbitalManifest.traitNames,
      ...StdUiCodeRunnerPanelCodeRunnerPanelOrbitalManifest.inlineTraitNames,
    ];
...
/**
 * Bundled params for ui-code-runner-panel — one optional entry per orbital.
 * Each entry maps to its per-orbital factory above.
 */
export interface StdUiCodeRunnerPanelParams {
  CodeRunnerPanel?: StdUiCodeRunnerPanelCodeRunnerPanelOrbitalParams;
}

/** Whole-organism descriptor (1 orbitals). Composes per-orbital factories. */
export function stdUiCodeRunnerPanel(params: StdUiCodeRunnerPanelParams = {}): OrbitalDefinition[] {
  return [
    stdUiCodeRunnerPanelCodeRunnerPanelOrbital(params.CodeRunnerPanel ?? {}),
  ];
}
