/**
 * std-realtime-chat — Realtime chat organism. Composes: stdMessaging(ChatMessage) + stdList(Channel) + stdDisplay(OnlineUser)
 *
...
const BEHAVIOR_PATH = 'std/behaviors/organisms/std-realtime-chat';
...
export function stdRealtimeChat(params: StdRealtimeChatParams): OrbitalDefinition[] {
  ...
  return [
    makeOrbitalWithUses({
      ...
      entity,
      traits: [
        makeTraitRef({ from: BEHAVIOR_PATH, ref: `${ALIAS}.traits.ChatMessageBrowse`, linkedEntity: params.entityName }),
        makeTraitRef({ from: BEHAVIOR_PATH, ref: `${ALIAS}.traits.ChatMessageCompose`, linkedEntity: params.entityName }),
        makeTraitRef({ from: BEHAVIOR_PATH, ref: `${ALIAS}.traits.ChatMessageView`, linkedEntity: params.entityName }),
      ],
      pages: [
    ...
    makeOrbitalWithUses({
      ...
      entity,
      traits: [
        makeTraitRef({ from: BEHAVIOR_PATH, ref: `${ALIAS}.traits.ChannelBrowse`, linkedEntity: params.entityName }),
        makeTraitRef({ from: BEHAVIOR_PATH, ref: `${ALIAS}.traits.ChannelCreate`, linkedEntity: params.entityName }),
        makeTraitRef({ from: BEHAVIOR_PATH, ref: `${ALIAS}.traits.ChannelEdit`, linkedEntity: params.entityName }),
        makeTraitRef({ from: BEHAVIOR_PATH, ref: `${ALIAS}.traits.ChannelView`, linkedEntity: params.entityName }),
        makeTraitRef({ from: BEHAVIOR_PATH, ref: `${ALIAS}.traits.ChannelDelete`, linkedEntity: params.entityName }),
      ],
      pages: [
        makePageRef({ from: BEHAVIOR_PATH, ref: `${ALIAS}.pages.ChannelsPage`, linkedEntity: params.entityName }),
      ],
    }),
    makeOrbitalWithUses({
      ...
      entity,
      traits: [
        makeTraitRef({ from: BEHAVIOR_PATH, ref: `${ALIAS}.traits.OnlineUserDisplay`, linkedEntity: params.entityName }),
      ],
      pages: [
        makePageRef({ from: BEHAVIOR_PATH, ref: `${ALIAS}.pages.OnlinePage`, linkedEntity: params.entityName }),
      ],
    }),
  ];
}
