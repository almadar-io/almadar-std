/**
 * std-marketing-cta — Call-to-action banner atom for marketing pages. Renders a high-conversion CTA section with title, subtitle, and action buttons. Pick for conversion points at the end of pages or between sections.
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/std-marketing-cta.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=std-marketing-cta
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/std-marketing-cta';
const ALIAS = 'MarketingCta';
 ...
 */
export interface StdMarketingCtaCtaPrimaryPayload {
  href?: string;
}
 ...
 */
export interface StdMarketingCtaCtaSecondaryPayload {
  href?: string;
}
...
/**
 * Params for the std-marketing-cta descriptor helpers.
 *
 ...
 */
export interface StdMarketingCtaParams {
  entityName: string;
  ...
  events?: Partial<Record<StdMarketingCtaEventKey, string>>;
  ...
  config?: StdMarketingCtaConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `MarketingCta.traits.CTAItemCTA`. */
export function stdMarketingCtaTrait(params: StdMarketingCtaParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.CTAItemCTA`,
...
/** Page descriptor: `MarketingCta.pages.CTAItemCTAPage`. */
export function stdMarketingCtaPage(params: StdMarketingCtaParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.CTAItemCTAPage`,
...
export function stdMarketingCta(params: StdMarketingCtaParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdMarketingCtaTrait(params),
    ],
    pages: [
      stdMarketingCtaPage(params),
    ],
  });
}
