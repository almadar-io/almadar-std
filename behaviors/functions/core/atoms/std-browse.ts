/**
 * std-browse — std-browse as a Function — single primitive: data-grid. Owns the fetch + REFETCH (query/filter/page) state machine. Consumers configure fields/imageField/itemActions/cols/gap/variant; the atom renders the grid.
 *
 ...
 *   node scripts/regenerate-std-ts.mjs --only=std-browse
 *
 * @level atom
...
export interface StdBrowseConfig {
  ...
  /** Default: `[{"name":"name","variant":"h4","label":"Name"},{"label":"Description","variant":"caption","name":"description"},{"name":"status","variant":"badge","label":"Status"}]` */
  fields?: TraitConfig[];
  /** Default: `[]` */
