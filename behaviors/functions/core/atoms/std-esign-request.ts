/**
 * std-esign-request — Generic e-signature request primitive: send a document for signing and track status.
 *
 ...
 *   node scripts/regenerate-std-ts.mjs --only=std-esign-request
 *
 * @level atom
