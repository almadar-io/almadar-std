/**
 * std-drawer — std-drawer — side-panel atom. Renders ONLY to its `drawer` slot. Host emits OPEN with payload {id, name, description} → renders side-panel; CLOSE clears it. Stateless: state lives in the OPEN payload, not the entity, so the trait stays safe under consumer entity rebinds.
 *
...
const BEHAVIOR_PATH = 'std/behaviors/std-drawer';
const ALIAS = 'Drawer';
