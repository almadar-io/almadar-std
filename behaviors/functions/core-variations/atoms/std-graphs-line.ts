/**
 * std-graphs-line — Line chart view. Embeds std-graphs with the line chartType — connected points over a continuous (typically time) axis. Best for trends and time-series.
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/std-graphs-line.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=std-graphs-line
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/std-graphs-line';
const ALIAS = 'GraphsLine';
...
/**
 * Params for the std-graphs-line descriptor helpers.
 *
 ...
 */
export interface StdGraphsLineParams {
  entityName: string;
  ...
  config?: StdGraphsLineConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `GraphsLine.traits.LineGraphItemGraph`. */
export function stdGraphsLineTrait(params: StdGraphsLineParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.LineGraphItemGraph`,
...
/** Page descriptor: `GraphsLine.pages.LineGraphPage`. */
export function stdGraphsLinePage(params: StdGraphsLineParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.LineGraphPage`,
...
export function stdGraphsLine(params: StdGraphsLineParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdGraphsLineTrait(params),
    ],
    pages: [
      stdGraphsLinePage(params),
    ],
  });
}
