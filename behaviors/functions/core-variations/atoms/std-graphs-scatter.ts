/**
 * std-graphs-scatter — Scatter plot view. Embeds std-graphs with scatter plot pattern override.
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/std-graphs-scatter.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=std-graphs-scatter
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/std-graphs-scatter';
const ALIAS = 'GraphsScatter';
...
/**
 * Params for the std-graphs-scatter descriptor helpers.
 *
 ...
 */
export interface StdGraphsScatterParams {
  entityName: string;
  ...
  config?: StdGraphsScatterConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `GraphsScatter.traits.ScatterGraphItemGraph`. */
export function stdGraphsScatterTrait(params: StdGraphsScatterParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.ScatterGraphItemGraph`,
...
/** Page descriptor: `GraphsScatter.pages.ScatterGraphPage`. */
export function stdGraphsScatterPage(params: StdGraphsScatterParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.ScatterGraphPage`,
...
export function stdGraphsScatter(params: StdGraphsScatterParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'ScatterGraphItemOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdGraphsScatterTrait(params),
    ],
    pages: [
      stdGraphsScatterPage(params),
    ],
  });
}
