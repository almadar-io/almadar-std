/**
 * std-graphs-bar — Bar chart view. Embeds std-graphs with the bar chartType — vertical bars, one per category bucket. Default for distribution-of-categories visualisations.
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/std-graphs-bar.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=std-graphs-bar
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/std-graphs-bar';
const ALIAS = 'GraphsBar';
...
/**
 * Params for the std-graphs-bar descriptor helpers.
 *
 ...
 */
export interface StdGraphsBarParams {
  entityName: string;
  ...
  config?: StdGraphsBarConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `GraphsBar.traits.BarGraphItemGraph`. */
export function stdGraphsBarTrait(params: StdGraphsBarParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.BarGraphItemGraph`,
...
/** Page descriptor: `GraphsBar.pages.BarGraphPage`. */
export function stdGraphsBarPage(params: StdGraphsBarParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.BarGraphPage`,
...
export function stdGraphsBar(params: StdGraphsBarParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    ...
    entity,
    traits: [
      stdGraphsBarTrait(params),
    ],
    pages: [
      stdGraphsBarPage(params),
    ],
  });
}
