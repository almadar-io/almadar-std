/**
 * std-detail-drawer — Drawer detail view. Embeds std-modal with drawer slot override.
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/std-detail-drawer.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=std-detail-drawer
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/std-detail-drawer';
const ALIAS = 'DetailDrawer';
...
/**
 * Params for the std-detail-drawer descriptor helpers.
 *
 ...
 */
export interface StdDetailDrawerParams {
  entityName: string;
  ...
  config?: StdDetailDrawerConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `DetailDrawer.traits.DetailDrawerModal`. */
export function stdDetailDrawerTrait(params: StdDetailDrawerParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.DetailDrawerModal`,
...
/** Page descriptor: `DetailDrawer.pages.DetailDrawerPage`. */
export function stdDetailDrawerPage(params: StdDetailDrawerParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.DetailDrawerPage`,
...
export function stdDetailDrawer(params: StdDetailDrawerParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'DetailDrawerOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdDetailDrawerTrait(params),
    ],
    pages: [
      stdDetailDrawerPage(params),
    ],
  });
}
