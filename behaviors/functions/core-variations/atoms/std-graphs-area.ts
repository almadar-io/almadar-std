/**
 * std-graphs-area — Area chart view. Embeds std-graphs with area chart pattern override.
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/std-graphs-area.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=std-graphs-area
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/std-graphs-area';
const ALIAS = 'GraphsArea';
...
/**
 * Params for the std-graphs-area descriptor helpers.
 *
 ...
 */
export interface StdGraphsAreaParams {
  entityName: string;
  ...
  config?: StdGraphsAreaConfig;
  /** URL path override for the (first) page. */
  pagePath?: string;
}

/** Trait descriptor: `GraphsArea.traits.AreaGraphItemGraph`. */
export function stdGraphsAreaTrait(params: StdGraphsAreaParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.AreaGraphItemGraph`,
...
/** Page descriptor: `GraphsArea.pages.AreaGraphPage`. */
export function stdGraphsAreaPage(params: StdGraphsAreaParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.AreaGraphPage`,
...
export function stdGraphsArea(params: StdGraphsAreaParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    name: 'AreaGraphItemOrbital',
    uses: [{ from: BEHAVIOR_PATH, as: ALIAS }],
    entity,
    traits: [
      stdGraphsAreaTrait(params),
    ],
    pages: [
      stdGraphsAreaPage(params),
    ],
  });
}
