/**
 * std-app-layout-minimal — Minimal chrome. Embeds std-app-layout with minimal layout pattern + a placeholder content trait so the main slot has visible content.
 *
 * Autogenerated by almadar-sync std-ts from
 * packages/almadar-std/behaviors/registry/atoms/std-app-layout-minimal.orb.
 *
 ...
 *   npx almadar-sync std-ts --only=std-app-layout-minimal
 *
 * @level atom
...
const BEHAVIOR_PATH = 'std/behaviors/std-app-layout-minimal';
 ...
 */
export interface StdAppLayoutMinimalParams {
  entityName: string;
...
/** Trait descriptor: `AppLayoutMinimal.traits.MinimalLayout`. */
export function stdAppLayoutMinimalMinimalLayoutTrait(params: StdAppLayoutMinimalParams): TraitReference {
  return makeTraitRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.traits.MinimalLayout`,
    linkedEntity: params.entityName,
    ...(params.traitName !== undefined ? { name: params.traitName } : {}),
    ...(params.events !== undefined ? { events: params.events as Record<string, string> } : {}),
    ...(params.effects !== undefined ? { effects: params.effects } : {}),
...
/** Page descriptor: `AppLayoutMinimal.pages.MinimalLayoutPage`. */
export function stdAppLayoutMinimalPage(params: StdAppLayoutMinimalParams): PageRefObject {
  return makePageRef({
    from: BEHAVIOR_PATH,
    ref: `${ALIAS}.pages.MinimalLayoutPage`,
...
export function stdAppLayoutMinimal(params: StdAppLayoutMinimalParams): OrbitalDefinition {
  const entity: Entity = {
  ...
  return makeOrbitalWithUses({
    ...
    pages: [
      stdAppLayoutMinimalPage(params),
    ],
  });
}
