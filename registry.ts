...
import { GRAPH_OPERATORS } from './modules/graph.js';
import { CONTRACT_OPERATORS } from './modules/contract.js';
...
import { BROWSER_OPERATORS } from './modules/browser.js';
...
export const STD_OPERATORS_BY_MODULE: Record<string, Record<string, StdOperatorMeta>> = {
  ...
  contract: CONTRACT_OPERATORS,
  data: DATA_OPERATORS,
  prob: PROB_OPERATORS,
  os: OS_OPERATORS,
  browser: BROWSER_OPERATORS,
